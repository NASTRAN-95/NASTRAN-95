...
!
   INTEGER :: Type
   INTEGER , DIMENSION(10) :: Ect
   INTEGER , DIMENSION(7) :: Elt
   INTEGER , DIMENSION(4) :: Grid
!
! Local variable declarations rewritten by SPAG
!
   REAL , DIMENSION(6) :: angle , heigth
   REAL :: area , dist , mag , tol
   REAL , DIMENSION(3) :: cs , kf , ks , r1 , r2 , r3
   INTEGER , DIMENSION(4,6,4) :: face
   INTEGER :: faceid , gf1 , gf2 , gf3 , gf4 , gs1 , gs2 , gs3 , gs4 , i , if , intype , j , nf , ngridf , ngrids
   INTEGER , DIMENSION(10) :: gf
   INTEGER , DIMENSION(4) , SAVE :: gridf , nface
   INTEGER , DIMENSION(4,6) , SAVE :: hex1 , hex2
   INTEGER , DIMENSION(4,4) , SAVE :: tetra
   INTEGER , DIMENSION(4,5) , SAVE :: wedge
!
