...
!
 ...
 40      IF ( .NOT.dec ) kard2 = orf(andf(Bimsk1(1),kard2),Bkmsk1(5))
            ...
            SPAG_Loop_2_1: DO j = 1 , 4
               ...
               SPAG_DispatchLoop_3: DO
                  ...
                  CASE (1)
                     ...
                     EXIT SPAG_Loop_2_1
                  CASE (2)
                     IF ( .NOT.dec ) exwrdi = orf(andf(exwrdi,Bimsk4(j)),lshift(k,sftji+Sftm))
