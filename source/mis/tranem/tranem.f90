!*==tranem.f90 processed by SPAG 8.01RF 16:18  2 Dec 2023
...
!
   REAL :: c , grds , s , sum , temp , ve1 , ve2 , ve3 , vm1 , vm2 , vm3 , vn1 , vn2 , vn3 , vndotm
   INTEGER , DIMENSION(4) :: ecpt
   INTEGER :: i , ic , ig , k
   REAL , DIMENSION(4) :: rcent
   INTEGER , DIMENSION(2) , SAVE :: subnam
   EXTERNAL mesage , transs
!
