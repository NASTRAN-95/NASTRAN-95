!*==dtshls.f90 processed by SPAG 8.01RF 14:47  2 Dec 2023
...
!
   REAL :: a , a1 , a1sq , a2 , a2sq , a3 , a3sq , b , c , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , cab1 , cab2 , cab3 ,  &
         & d13 , d132 , d23 , d232 , d33 , d334 , determ , h4 , h5 , h6 , j11 , j12 , j22 , nsm , rix , riy , rjx , rjy , rkx ,     &
         & rky , rlx , rly , rmnx , rmny , rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny , rny1 , sb1 , sb10 , sb11 , sb12 , sb13 ,    &
         & sb14 , sb15 , sb16 , sb17 , sb18 , sb19 , sb2 , sb20 , sb21 , sb22 , sb23 , sb24 , sb25 , sb26 , sb27 , sb28 , sb29 ,    &
         & sb3 , sb30 , sb31 , sb32
   REAL , DIMENSION(36) :: balotr , ksub , ksubt , tmmm
   REAL , SAVE :: blank , degra
   REAL , DIMENSION(3) :: cab , el , fl , gl , ivect , jvect , kvect , sigx , sigxy , sigy , str , stress , vec
   REAL , DIMENSION(30,30) :: cm1
   REAL , DIMENSION(900) :: cms
   REAL , DIMENSION(1296) :: cmt
   REAL , DIMENSION(5,5) :: csub
   REAL , DIMENSION(6,5) :: csubt
   REAL , DIMENSION(36,36) :: ctm
   REAL , DIMENSION(30) :: ee
   REAL , DIMENSION(6) :: ee1 , eph1 , es , xc , yc , zc
   REAL , DIMENSION(9) :: emod , trand , trans
   INTEGER :: i , i1 , i2 , i3 , idele , ii , iirr , iirr1 , ij , ij1 , ijk , ik , ikrr , ikrr0 , ikrr1 , im , imrr1 , ising , ix , &
            & iy , j , j1 , j2 , ji , jj , jjss , jjss0 , jl , jlss , jlss0 , jlss1 , jn , jnss , jx , jy , k , k1 , k2 , ki ,      &
            & kirr , kirr0 , kirr1 , kk , kkrr , kkrr0 , km , kmrr , kx , ky , l , l1 , lj , ljss , ljss0 , ljss1 , ll , llss ,     &
            & llss1 , ln , lnss1 , lx , ly , m , matid1 , matid2 , matid3 , mi , mirr1 , mk , mkrr , mm , mmrr , mmrr0 , mmrr1 ,    &
            & mx , my , mz , nj , njss , nlss1
   INTEGER , DIMENSION(6) :: ics , nl , sil
   INTEGER , DIMENSION(100) :: iest
   INTEGER , DIMENSION(6,3) :: ind
   INTEGER , DIMENSION(20,3) :: index
   REAL , DIMENSION(1024) :: kshl
   REAL(REAL64) , DIMENSION(36) :: ksubd
   INTEGER , DIMENSION(2) , SAVE :: name
   INTEGER :: nn , nnss , nnss0 , nnss1 , npivot , npoint , npt1 , nx , ny , rr , rr0 , rr1 , sil1 , sil2 , ss , ss0 , ss1
   ...
   REAL :: sb33 , sb34 , sb35 , sb36 , sb37 , sb38 , sb39 , sb4 , sb40 , sb5 , sb6 , sb7 , sb8 , sb9 , st , tbend1 , tbend3 ,       &
         & tbend5 , tem , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 , tshr , tshr1 , tshr3 , tshr5 , x , y
   REAL , DIMENSION(3,12) :: tm
   INTEGER , DIMENSION(32) , SAVE :: xu , xv , xw , yu , yv , yw
   EXTERNAL af , ds1b , gmmats , invers , mat , transs , trif
!
