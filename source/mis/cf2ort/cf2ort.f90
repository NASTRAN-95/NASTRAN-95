...
!
   ...
   INTEGER :: Nzero
   INTEGER :: Iortho
   REAL(REAL64) , DIMENSION(1) :: Vr
   REAL(REAL64) , DIMENSION(1) :: Vl
...
!
   ...
   REAL(REAL64) , DIMENSION(4) :: otest
   LOGICAL :: skip
   EXTERNAL cfnor2 , close , gopen , unpack
!
...
99006 FORMAT (3H --,32(4H----),/(1H ,4D25.16))
END SUBROUTINE cf2ort
