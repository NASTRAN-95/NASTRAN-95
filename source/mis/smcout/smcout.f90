!*==smcout.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!WKBIE 7/95 SPR95005
         ...
         CYCLE SPAG_DispatchLoop_1
      CASE (5)
         DO WHILE ( dabs(ddr**2+ddc**2)>=10.D0 )
            ddr = ddr/10.
            ddc = ddc/10.
            power = power + 1
         ENDDO
...
99001    FORMAT (A23,' 3181, ATTEMPT TO PERFORM CHOLESKY DECOMPOSITION',' ON A NEGATIVE DEFINITE MATRIX IN SUBROUTINE SMCOMP.',/,   &
         ...
         spag_nextblock_1 = 8
      CASE (8)
         WRITE (nout,99002) uwm , kcol , rzero
