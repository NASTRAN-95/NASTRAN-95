!*==bars.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
   REAL :: a2b , ael , beta , bl , bl13 , bl22 , blcube , blsq , blsq3 , blsq4 , const , ei1 , ei2 , fl , fll , fm , gak1 , gak2 ,  &
         & gjl , l2b3 , l2b6 , lb , limit , lr1 , lr2 , r1 , r2 , sk1 , sk2 , sk3 , sk4
   LOGICAL :: aofset , basic , bofset , offset
   INTEGER , DIMENSION(7) :: dict
   REAL , DIMENSION(42) :: ecpt
   REAL , SAVE :: epsi , epsi2
