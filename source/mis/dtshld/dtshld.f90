...
!
   REAL :: a , a1 , a1sq , a2 , a2sq , a3 , a3sq , b , c , cab1 , cab2 , cab3 , d13 , d23 , d33 , j11 , j12 , j22 , nsm , tbend1 ,  &
         & tbend3 , tbend5 , tem , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 , tshr , tshr1 , tshr3 , tshr5
   REAL(REAL64) , DIMENSION(36) :: balotr , ksub , ksubt
   REAL , SAVE :: blank , degra
   REAL(REAL64) :: c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , d132 , d232 , d334 , determ , h4 , h5 , h6 , rix , riy , rjx ,&
                 & rjy , rkx , rky , rlx , rly , rmnx , rmny , rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny , rny1 , sb1 , sb10 ,     &
                 & sb11 , sb12 , sb13 , sb14 , sb15 , sb16 , sb17 , sb18 , sb19 , sb2 , sb20 , sb21 , sb22 , sb23 , sb24 , sb25 ,   &
                 & sb26 , sb27 , sb28 , sb29 , sb3 , sb30 , sb31 , sb32 , sb33 , sb34 , sb35 , sb36 , sb37 , sb38 , sb39 , sb4 ,    &
                 & sb40 , sb5 , sb6 , sb7 , sb8 , sb9 , st , x , y
   REAL(REAL64) , DIMENSION(3) :: cab
   REAL(REAL64) , DIMENSION(30,30) :: cm1
   REAL(REAL64) , DIMENSION(900) :: cms
   REAL(REAL64) , DIMENSION(1296) :: cmt
   REAL(REAL64) , DIMENSION(5,5) :: csub
   REAL(REAL64) , DIMENSION(6,5) :: csubt
   REAL(REAL64) , DIMENSION(36,36) :: ctm
   REAL(REAL64) , DIMENSION(30) :: ee
   REAL , DIMENSION(6) :: ee1 , eph1 , es , xc , yc , zc
   REAL , DIMENSION(3) :: el , fl , gl , ivect , jvect , kvect , sigx , sigxy , sigy , str , stress , vec
   REAL , DIMENSION(9) :: emod , trans
   INTEGER :: i , i1 , i2 , i3 , idele , ii , iirr , iirr1 , ij , ij1 , ik , ikrr , ikrr0 , ikrr1 , im , imrr1 , ising , ix , iy ,  &
            & j , j1 , j2 , ji , jj , jjss , jjss0 , jl , jlss , jlss0 , jlss1 , jn , jnss , jx , jy , k , k1 , k2 , ki , kirr ,    &
            & kirr0 , kirr1 , kk , kkrr , kkrr0 , km , kmrr , kx , ky , l , l1 , lj , ljss , ljss0 , ljss1 , ll , llss , llss1 ,    &
            & ln , lnss1 , lx , ly , m , matid1 , matid2 , matid3 , mi , mirr1 , mk , mkrr , mm , mmrr , mmrr0 , mmrr1 , mx , my ,  &
            & mz , nj , njss , nlss1 , nn
   INTEGER , DIMENSION(6) :: ics , nl , sil
   INTEGER , DIMENSION(100) :: iest
   INTEGER , DIMENSION(6,3) :: ind
   INTEGER , DIMENSION(20,3) :: index
   REAL(REAL64) , DIMENSION(1024) :: kshl
   INTEGER , DIMENSION(2) , SAVE :: name
   INTEGER :: nnss , nnss0 , nnss1 , npivot , npoint , npt1 , nx , ny , rr , rr0 , rr1 , sil1 , sil2 , ss , ss0 , ss1
   LOGICAL :: nogo , nots , uniben , unimem
   REAL , DIMENSION(250) :: ph1out
   REAL(REAL64) , DIMENSION(6,6) :: q
   REAL(REAL64) , DIMENSION(960) :: qks
   REAL(REAL64) , DIMENSION(20,20) :: qqq
   REAL(REAL64) , DIMENSION(360) :: qqqinv
   INTEGER , DIMENSION(3) , SAVE :: rk , rl , sk , sl
   REAL , DIMENSION(3,12) :: tm
   REAL , DIMENSION(36) :: tmmm
   REAL(REAL64) , DIMENSION(9) :: trand
   INTEGER , DIMENSION(32) , SAVE :: xu , xv , xw , yu , yv , yw
   EXTERNAL af , ds1b , gmmatd , gmmats , inverd , mat , transd , transs , trif
!
