!*==etrbms.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
   ...
   REAL , DIMENSION(9) :: d , g , mbaraa
   REAL , DIMENSION(1) :: ecpt
   REAL , DIMENSION(4) :: g2x2 , j2x2
   REAL , DIMENSION(6) :: hyq
   INTEGER :: i , ising , j , k , npt
   REAL , DIMENSION(18) :: mar , s
   REAL , DIMENSION(36) :: mrr
   REAL , DIMENSION(7,7) :: siij
