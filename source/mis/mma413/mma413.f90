!*==mma413.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
!
!     MMA413 PERFORMS THE MATRIX OPERATION USING METHOD 41
!       IN COMPLEX SINGLE PRECISION
!       (+/-)A(T & NT) * B (+/-)C = D
!
!     MMA413 USES METHOD 41 WHICH IS AS FOLLOWS:
            ...
            DO i = 1 , ncolpp
               ...
               SPAG_Loop_3_3: DO WHILE ( indxb<indxbl )
                  ...
                  ELSE
                     ...
                     IF ( Zc(indxbv)==0.0 ) EXIT SPAG_Loop_3_3
                     indxa = 1
                     DO
                        irowa1 = Zi(indxa)
                        ntms = Zi(indxa+1)
