...
!
   REAL :: a , a1sq , a2sq , a3sq , amass , area , b , c , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , d11 , d12 , d13 ,     &
         & d132 , d22 , d23 , d232 , d33 , d334 , determ , nsm , rho , rmnx , rmny , rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny ,   &
         & rny1 , s11 , s13 , s22 , s23 , s33 , st , t1 , t2 , t3 , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 ,  &
         & tshr1 , tshr3 , tshr5 , vol
   REAL , DIMENSION(36) :: balotr , ksup , ksupt
   REAL , SAVE :: blank , degra
   REAL , DIMENSION(10) :: cc
   REAL , DIMENSION(1296) :: cmt
   REAL , DIMENSION(3,3) :: csub
   REAL , DIMENSION(6,3) :: csubt
   INTEGER , DIMENSION(11) :: dict
   REAL , DIMENSION(18) :: e
   REAL , DIMENSION(14,14) :: f
   INTEGER :: i , i1 , i1j1 , i2 , i3 , icode , idele , ii , ij , ioutpt , ipass , iprec , ising , ism , ismall , j , j1 , j11 ,    &
            & j12 , j1i1 , j22 , ji , jj , k , k1 , l , l1 , m , matid1 , matid2 , mx , mx0 , mx01 , mx011 , mx0x , mx1 , mx1x ,    &
            & mx2 , mx2x , mx3 , mx3x , my , my1 , my1x , ndof , nx , nx0 , nx01 , nx011 , nx0y , nx1 , nx1y , nx2 , nx2y , nx3 ,   &
            & nx3y , ny , ny1 , ny1y , sil1 , sil2
   ...
   REAL , DIMENSION(6,6) :: ksub , ksubt
   REAL , DIMENSION(400) :: ktr3 , mtr3
   INTEGER , DIMENSION(2) , SAVE :: name
   REAL , DIMENSION(20,20) :: qqq
   REAL , DIMENSION(360) :: qqqinv
   REAL , DIMENSION(9) :: trand
   REAL , DIMENSION(60) :: ts1 , ts2 , ts7
   REAL , DIMENSION(40) :: ts6 , ts6s
   REAL , DIMENSION(6) :: xc , yc , zc
   INTEGER , DIMENSION(20) , SAVE :: xpower , ypower
   INTEGER , DIMENSION(10) , SAVE :: xthk , ythk
   EXTERNAL af , emgout , gmmats , invers , mat , sswtch , transs , trif , tspl1s , tspl3s
!
...
!     ECPT(14) = THICKNESS TSHR1 FOR TRANSVERSE SHEAR AT GRID
!     ECPT(15) = THICKNESS TSHR3 FOR TRANSVERSE SHEAR AT GRID
!     ECPT(16) = THICKNESS TSHR5 FOR TRANSVERSE SHEAR AT GRID
...
!     CALCULATIONS
!
            IF ( .NOT.(nots) ) CALL tspl1s(ts1,ts2,ts6,ts6s,ts7,ktr3,cmt(761))
         ENDIF
!
!
...
!     ARE REQUESTED  - NOT NEEDED IF FIELD 7 IN GRID CARD IS ZERO)
!
