...
MODULE C_DDRMC1
   ...
   REAL :: Device, Form, Lambda, Omega
   INTEGER :: Dhsize, Entrys, File, I1, I2, Icc, Idout, Ierror, Ilist, Infile, Ipass, Istlst, Itemp, Itype1, Itype2, &
            & Jfile, Lsf, Lstlst, Ncc, Ncore, Nlambs, Nlist, Nptsf, Nsols, Nwds, Nwdsf, Nwords, Outfil, Passes,       &
            & Phase, Setid, Subcas, Uvsol
