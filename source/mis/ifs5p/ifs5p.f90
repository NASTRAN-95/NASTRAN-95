...
!
         ...
         IF ( Rm(6)>180.0 .OR. Rm(7)>180.0 ) GOTO 400
         GOTO 500
      ELSEIF ( Ky==55 ) THEN
!
!*****         255-PLOAD3     ******************************************
...
!
         ...
         IF ( Mf(3)/=2 .OR. Rm(4)<=Rm(3) ) GOTO 400
         GOTO 3600
      ELSEIF ( Ky==77 ) THEN
!
!*****         277-POPT         ****************************************
