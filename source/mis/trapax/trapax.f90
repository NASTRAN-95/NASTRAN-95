!*==trapax.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   ...
   REAL , DIMENSION(48) :: acurp1 , akuph , d1
   REAL , DIMENSION(16) :: acurp2 , akph2 , d2
   REAL :: ajho , ajjho , ar , c2 , c2s2 , c3 , c4 , cosg , cs , cs2 , del , dict5 , gamr , rhod , rmax , rmin , s2 , s3 , s4 ,     &
         & sc2 , sing , v , vr , vz , zmin
   REAL , DIMENSION(144) :: ak , bmbss , d
   REAL , DIMENSION(256) :: akj
   REAL , DIMENSION(12,12) :: bmass , gb
   REAL , DIMENSION(12) :: delint
   INTEGER , DIMENSION(14) :: dict
   REAL , DIMENSION(20) :: ecpt
   REAL , DIMENSION(63) :: ee
   REAL , DIMENSION(4,4) :: gbp
   INTEGER :: i , i1 , ib , ic , idel1 , ik , ika , ikc , ikj , ikja , ikjb , ikjc , iout , ip , iq , ising , isort , it , j , jt , &
            & k , kk , korm , ksave , l , masor , mjho
   INTEGER , DIMENSION(4) :: ics , ipart
   INTEGER , SAVE :: idel2 , jax
   INTEGER , DIMENSION(39) :: iecpt
   LOGICAL :: lsys78 , pzmat
   REAL , DIMENSION(4) :: r , z
   REAL , DIMENSION(36) :: sp
