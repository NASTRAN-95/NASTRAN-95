...
!
   REAL :: a1 , a2 , a3 , area , flag , pmag , sin1 , sin2 , sin3 , v1 , v2 , v3
   REAL , DIMENSION(3) :: gpco1 , gpco2 , gpco3 , gpco4 , vect , vect1 , vect2 , vect3
   INTEGER , DIMENSION(5) :: gridp
   INTEGER :: i , in , j , l , n1
   INTEGER , DIMENSION(4,4) :: igpco
   INTEGER , DIMENSION(4) :: iord , pont
   INTEGER , DIMENSION(2) , SAVE :: name
   REAL , SAVE :: pi
   REAL , DIMENSION(3,4) :: ploads
   EXTERNAL basglb , cross , fndpnt , fndsil , mesage , permut , read
!
