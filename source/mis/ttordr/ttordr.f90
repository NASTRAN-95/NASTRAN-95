...
!
   REAL :: a1 , a2 , cosa1 , cosa2 , degra , del , djp1 , dtf1 , dtf2 , dtm1 , dtm2 , ep , et , phib , r1 , r2 , rp , s , sina1 ,   &
         & sina2 , tempe , tf , tm , twopi , tz , vpt , vtp , z1 , z2
   REAL , DIMENSION(36) :: aki , d
   REAL , DIMENSION(2) :: alph , r , z
   REAL , DIMENSION(42) :: delint
   REAL , DIMENSION(4) :: ee
   REAL , DIMENSION(40) :: ffe , fme
   REAL , DIMENSION(144) :: gambl , gambq , gamrs
   REAL , DIMENSION(72) :: gambqf
   REAL , DIMENSION(48) :: gambqm
   INTEGER :: i , idel , ip , itord , j , jp1 , k , kj , kk , kl , l , matid
   INTEGER , DIMENSION(2) :: ics , igp
   INTEGER , DIMENSION(18) :: iecpt
   REAL , DIMENSION(12) :: tl
   EXTERNAL fcurl , gbtran , gmmats , mat , mesage , romber
!
