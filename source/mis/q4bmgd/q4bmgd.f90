...
!
   ...
   REAL(REAL64) , DIMENSION(9) :: Phi
   REAL(REAL64) , DIMENSION(1) :: Bmatrx
!
! Local variable declarations rewritten by SPAG
!
   REAL(REAL64) , DIMENSION(6) :: atrans , bsbar1
   REAL(REAL64) :: bb1 , bb2 , bb3 , deriv , term , thick
   REAL(REAL64) , DIMENSION(120) :: bbar
   REAL(REAL64) , DIMENSION(48) :: bsbar
   INTEGER :: i , ib , ibar , iji , ipoint , itot , j , k , ka , kbar , kk , kkk , kp1 , kp2 , kpoint , m , n , nd2 , nd3 , nd4 ,   &
            & nd5 , nd6 , ndof , ndof3 , nn
   REAL(REAL64) , DIMENSION(9) :: tee
   EXTERNAL gmmatd
!
