!*==frbk2.f90 processed by SPAG 8.01RF 14:46  2 Dec 2023
...
!
   INTEGER :: base , i , ib , ie , ifb , ii , ik , j , ji , jj , l16 , ll , ll2 , mcbltx , nam , nrec , nrow , ntms , nwds
   INTEGER , DIMENSION(6) , SAVE :: buf
   INTEGER , DIMENSION(15) :: iblk
   INTEGER , DIMENSION(2) :: ljj
   REAL(REAL64) :: sum , v3j , xljj
   REAL(REAL64) , DIMENSION(1) :: xl
   REAL(REAL64) , SAVE :: zero
   EXTERNAL conmsg , endget , endgtb , frmltd , fwdrec , getstb , getstr , mesage , read , rewind , skprec
!
