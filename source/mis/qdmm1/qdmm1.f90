...
!
   REAL :: cth1 , cth2 , cth31 , cth32 , cth41 , cth42 , degra , dlt1 , dlt2 , h , hh , la , lb , lbd1 , lc , lcd1 , lcd2 , ld ,    &
         & ldd2 , magi , magj , magk , pi1 , pi2 , pi3 , pj1 , pj2 , pj3 , pk1 , pk2 , pk3 , sth1 , sth2 , sth31 , sth32 , sth41 ,  &
         & sth42 , temp , theta , x12 , x13 , x14 , x21 , x23 , x24 , x31 , x34 , x41 , x42 , y21 , y31 , y34 , y3a , y41 , y42 ,   &
         & y4a , z21 , z31 , z41 , z42
   REAL , DIMENSION(9) :: e , g
   REAL , DIMENSION(26) :: ecpt
   INTEGER :: i , i1 , iict , isw , jj , jjct , jjk , k , k19 , ka , kkct , ktot , l , llct , mmct , nnct
   EXTERNAL basglb , gmmats , mat , mesage
!
