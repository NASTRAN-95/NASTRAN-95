!*==bar.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   ...
   REAL :: ael , alphal , beta , delta , ei1 , ei2 , fl , fll , gak1 , gak2 , gjl , l , l2b3 , l2b6 , lb , lcube , lr1 , lr2 , lsq ,&
         & r1 , r2 , sk1 , sk2 , sk3 , sk4 , tbar
   REAL , DIMENSION(100) :: ecpt
   INTEGER :: i , icsida , icsidb , idela , idelb , ig , ii , ij , ikel , il , ill , index , isasb , isv , iwbeg , j , jcsid ,      &
