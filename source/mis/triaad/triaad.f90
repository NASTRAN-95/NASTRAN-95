!*==triaad.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL*8 :: aa , ajho , ajjho , area , c1 , c2 , c2s2 , c3 , c4 , convm , cosg , degrad , del , dgamar , dgamr , er , et , ez ,    &
           & gor , grz , gzo , pi , rhod , s2 , s4 , sing , twopi , vor , voz , vro , vrz , vzo , vzr , z1 , z2 , z3 , za , zmin
   REAL*8 , DIMENSION(27) :: acurp1 , akuph , d1
   REAL*8 , DIMENSION(9) :: acurp2 , akip , akph2 , amt , d2
   REAL*8 , DIMENSION(81) :: ak , akjm , akm , d
   REAL*8 , DIMENSION(9,9) :: bmass , gababq
   REAL :: cs , cs2 , dict5 , dr , ra , rh , s3 , sc2
   REAL*8 , DIMENSION(12) :: delint , delm
   INTEGER , DIMENSION(11) :: dict
   REAL , DIMENSION(34) :: ecpt
   REAL*8 , DIMENSION(63) :: ee
   REAL*8 , DIMENSION(3,3) :: gababp
