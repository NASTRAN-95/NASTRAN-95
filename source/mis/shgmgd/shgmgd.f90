!*==shgmgd.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
   INTEGER :: Elid
   REAL(REAL64) , DIMENSION(9) :: Tem
   INTEGER , DIMENSION(4) :: Mid
   REAL(REAL64) :: Ts
   LOGICAL :: Noalfa
   REAL(REAL64) , DIMENSION(36) :: G
   REAL(REAL64) :: Rho
   REAL :: Gsube
   REAL :: Tsub0
   REAL(REAL64) , DIMENSION(4) :: Egnor
   REAL(REAL64) , DIMENSION(6) :: Alpha
!
! Local variable declarations rewritten by SPAG
!
   REAL(REAL64) :: bdum , const , detu , dn12 , dn21 , ps1 , ps2
   REAL :: e1 , e2 , g12x , g1z , g2z , nu12 , nu21 , tmtset
   REAL(REAL64) , DIMENSION(9) :: gt , u
   INTEGER :: ig , igobk , isngu , it0 , l , lpoint , m , morb , mtype
   INTEGER , DIMENSION(3,3) :: index
   INTEGER , DIMENSION(2) , SAVE :: name
   REAL(REAL64) , DIMENSION(6) :: talpha
   EXTERNAL gmmatd , inverd , mat
!
...
!
         IF ( G(19)/=0.0D0 .OR. G(20)/=0.0D0 .OR. G(21)/=0.0D0 .OR. G(22)/=0.0D0 ) EXIT SPAG_Loop_1_1
         igobk = 1
         m = 2
         Mid(3) = 0
         shrflx = .FALSE.
