...
!
   REAL :: a , amass , area , b , c , c1 , c2 , c3 , determ , dista , distb , distc , g11 , g12 , g13 , g22 , g23 , g33 , nsm ,     &
         & rho , st , st1 , theta1 , thetam , tmem1 , tmem3 , tmem5 , vol
   REAL , DIMENSION(9) :: balotr , krt , krt1 , trand
   REAL , SAVE :: blank , degra
   REAL , DIMENSION(3) :: cc , ivect , jvect , kvect
   INTEGER , DIMENSION(11) :: dict
   REAL , DIMENSION(6) :: e , xc , yc , zc
   REAL , DIMENSION(6,6) :: f , gk11 , gk12 , gk22 , q
   REAL , DIMENSION(12,12) :: gkt , gktrm , ktrm
   ...
   REAL , DIMENSION(2,2) :: ksub
   REAL , DIMENSION(3,2) :: ksubt
   REAL , DIMENSION(3,3) :: ktr , ktr1
   REAL , DIMENSION(324) :: ktrmg
   INTEGER , DIMENSION(2) , SAVE :: name
   REAL , DIMENSION(36) :: qinv
   INTEGER , DIMENSION(3) , SAVE :: rk , sk
   INTEGER , DIMENSION(12) , SAVE :: xu , xv , yu , yv
   EXTERNAL af , emgout , gmmats , invers , mat , transs , trif
!
