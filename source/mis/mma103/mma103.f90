!*==mma103.f90 processed by SPAG 8.01RF 16:18  2 Dec 2023
...
!
!
!     MMA103 PERFORMS THE MATRIX OPERATION USING METHOD 10 AND IN
 ...
 10         irowb1 = 0
         ...
         CASE (2)
            IF ( ifile/=0 ) THEN
               ...
               CALL unpack(*20,ifile,Zc(idx2+1))
               spag_nextblock_1 = 3
               CYCLE SPAG_DispatchLoop_1
            ENDIF
 20         DO j = 1 , ndr
