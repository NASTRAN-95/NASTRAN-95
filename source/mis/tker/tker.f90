...
!
   REAL :: beta2 , bigr , c1 , c10 , c11 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , car , ck1i , ck1r , ck2i , ck2r , dk1i , dk1r ,  &
         ...
         & j00i , j00r , j0ui , j0ur , k1 , k2 , mu , mu1 , q1 , q10 , q11 , q2 , q3 , q4 , q5 , q6 , q7 , q8 , q9 , r1 , r10 ,     &
         & r11 , r1s , r2 , r3 , r4 , r5 , r6 , r7 , r8 , r9 , t2p
   INTEGER :: ichuz
!
...
!
            ...
            IF ( ichuz/=1 ) THEN
               ...
               ELSE
                  ...
                  q11 = r11/c11
                  IF ( ichuz==1 ) GOTO 10
                  IF ( ichuz==2 .OR. ichuz==3 ) GOTO 5
                  IF ( ichuz==4 ) THEN
                  ELSEIF ( ichuz==7 ) THEN
                     i10i = -k1*i00r
                  ELSE
                     j00r = q1*(.138384-k2) + q2*(.553536-k2) + q3*(1.245456-k2) + q4*(2.214144-k2) + q5*(3.4596-k2)                &
                          & + q6*(4.981824-k2) + q7*(6.780816-k2) + q8*(8.856576-k2) + q9*(11.209104-k2) + q10*(13.8384-k2)         &
                          & + q11*(16.744464-k2)
                     i20r3 = 2. + k1*i00i + k2*j00r
                     IF ( ichuz==1 ) GOTO 10
                     IF ( ichuz==2 .OR. ichuz==3 .OR. ichuz==5 ) GOTO 5
                     IF ( ichuz==4 .OR. ichuz==6 ) THEN
                     ELSEIF ( ichuz==7 ) THEN
                        i10i = -k1*i00r
                     ELSE
                        j00i = -k1*(.744*q1+1.488*q2+2.232*q3+2.976*q4+3.72*q5+4.464*q6+5.208*q7+5.952*q8+6.696*q9+7.44*q10+        &
                             & 8.184*q11)
               ...
               ENDIF
               i10r = 1. + k1*i00i
               IF ( ichuz==1 .OR. ichuz==4 ) GOTO 10
               IF ( ichuz==7 .OR. ichuz==8 .OR. ichuz==9 ) THEN
                  spag_nextblock_1 = 3
                  CYCLE SPAG_DispatchLoop_1
               ENDIF
 5             j0ur = e*(q1*(0.138384-k2+0.372*mu*c1)                                                                               &
                    ...
                    & )
               j0ui = -                                                                                                             &
                    & k1*(e*(q1*(0.744+mu*c1)+e*(q2*(1.488+mu*c2)+e*(q3*(2.232+mu*c3)+e*(q4*(2.976+mu*c4)+e*(q5*(3.720+mu*c5)+e*(q6*&
                    & (4.464+mu*c6)                                                                                                 &
                    & +e*(q7*(5.208+mu*c7)+e*(q8*(5.952+mu*c8)+e*(q9*(6.696+mu*c9)+e*(q10*(7.44+mu*c10)+e*(q11*(8.184+mu*c11))))))))&
                    & )))))
            ENDIF
 10         i0ur = .372*e*(r1+e*(2.*r2+e*(3.*r3+e*(4.*r4+e*(5.*r5+e*(6.*r6+e*(7.*r7+e*(8.*r8+e*(9.*r9+e*(10.*r10+e*11.*r11))))))))))
            ...
            ELSE
               ...
               IF ( ichuz==1 .OR. ichuz==7 .OR. ichuz==8 .OR. ichuz==9 ) THEN
                  spag_nextblock_1 = 3
                  CYCLE SPAG_DispatchLoop_1
               ENDIF
               IF ( ichuz==4 ) THEN
            ...
            IF ( ichuz==1 .OR. ichuz==2 .OR. ichuz==3 .OR. ichuz==7 .OR. ichuz==8 .OR. ichuz==9 ) THEN
               spag_nextblock_1 = 3
               CYCLE SPAG_DispatchLoop_1
            ENDIF
            IF ( ichuz/=4 ) THEN
      ...
      CASE (3)
         ...
         c6 = cos(c5)
         c7 = sin(c5)
         IF ( ichuz/=1 .AND. ichuz/=3 .AND. ichuz/=4 .AND. ichuz/=6 ) THEN
            IF ( ichuz==2 .OR. ichuz==5 ) THEN
               spag_nextblock_1 = 5
               CYCLE SPAG_DispatchLoop_1
            ENDIF
      ...
      CASE (4)
         ...
         spag_nextblock_1 = 5
      CASE (5)
         c8 = (beta2*(r1/bigr)**2+(2.+mu1*c3)/(c4*c4))*(-c3/c4)
         c9 = (k1*c3)*(c3/c4)
