...
!
   REAL , DIMENSION(33) :: Ecpt
   INTEGER , DIMENSION(9) :: Iecpt
   REAL :: L
   REAL , DIMENSION(1) :: Pa
   REAL , DIMENSION(1) :: Pb
!
...
!
   REAL :: a , ael , beta , ei1 , ei2 , fj , gak , gjl , i1 , i12 , i2 , k1 , k2 , l2 , l2b3 , l2b6 , l3 , lb , lr1 , lr2 , r1 ,    &
         & r2 , sk1 , sk2 , sk3 , sk4
   INTEGER :: i , ii , ij , il , ill , ip , ip12 , j , j12 , ji , jll , k , ka , kb , ll
   INTEGER , DIMENSION(10) :: ipin
   REAL , DIMENSION(144) :: ke , kep
   REAL , DIMENSION(12) :: pe , pep
!
