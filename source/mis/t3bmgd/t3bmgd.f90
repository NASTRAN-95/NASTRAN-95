!*==t3bmgd.f90 processed by SPAG 8.01RF 14:47  2 Dec 2023
...
!
   ...
   REAL(REAL64) , DIMENSION(4,1) :: Egpdt
   REAL(REAL64) , DIMENSION(1) :: Dgpth
   REAL(REAL64) , DIMENSION(1) :: Aic
   REAL(REAL64) :: Th
   REAL(REAL64) :: Detjac
   REAL(REAL64) , DIMENSION(3) :: Shp
   REAL(REAL64) , DIMENSION(1) :: Bterms
   REAL(REAL64) , DIMENSION(1) :: Bmatrx
!
! Local variable declarations rewritten by SPAG
!
   REAL(REAL64) :: dnx , dny , eta , etai , psi , psii , shpf , xsi , xsii
   REAL(REAL64) , DIMENSION(3) :: dshpe , dshpx , tdshpe , tdshpx , tshp
   REAL(REAL64) , SAVE :: eps
   INTEGER :: i , i71 , i72 , i81 , i82 , i91 , i92 , ii , ip , ipt1 , ish , j , kk , nd1 , nd2 , nd3 , nd4 , nd5 , nd6 , nd7 ,     &
            & nd8 , nd9 , nnode
   REAL(REAL64) , DIMENSION(4) :: jacob
   REAL(REAL64) , DIMENSION(2,7) , SAVE :: ptint
   REAL(REAL64) , DIMENSION(2,3) , SAVE :: trc
   REAL(REAL64) , DIMENSION(2) :: vi , vj
!
