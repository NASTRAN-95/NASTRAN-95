!*==smc2rs.f90 processed by SPAG 8.01RF 14:47  2 Dec 2023
!!SPAG Open source Personal, Educational or Academic User  NON-COMMERCIAL USE - Not for use on proprietary or closed source code
 
 
SUBROUTINE smc2rs(Zi,Zs,Zil,Zol,Nar,Lasrow,Rtemp,I1,I2,I3)
   USE I_SMCOMX
   IMPLICIT NONE
   INCLUDE 'SMCOMX.COM'
   INTEGER I1 , I2 , I3
   INTEGER Lasrow(I2) , Nar(I3) , Zi(10)
   REAL Rtemp(I3) , Zil(I1,I2) , Zol(I2,2) , Zs(10)
...
!
                           zoltmp = Zol(j,ic1)
                           CALL smccrs(Rtemp(iilrow1),Zil(iilrow1,j),limit-iilrow1+1,zoltmp)
                        ENDIF
