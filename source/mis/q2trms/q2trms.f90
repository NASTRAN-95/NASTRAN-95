...
!
   ...
   REAL :: Isinth
   REAL :: Icosth
   REAL , DIMENSION(9) :: Gsube
   REAL :: It
   INTEGER :: Ierror
   INTEGER :: Iopt
   REAL , DIMENSION(1) :: Kmat
   REAL , DIMENSION(1) :: Pmat
   REAL , DIMENSION(1) :: Smat
   REAL , DIMENSION(1) :: Zmat
!
! Local variable declarations rewritten by SPAG
!
   REAL , DIMENSION(3) :: alp , ivec , jvec , kvec , tm3 , v12 , v13
   REAL , DIMENSION(3,6) :: c
   REAL , DIMENSION(6) :: ca , cb , cc
   REAL , DIMENSION(9) :: e , hitge , temp9 , tm
   REAL , DIMENSION(27) :: hi
...
!*****
                     CALL gmmats(hitge,3,3,0,alp,3,1,0,Pmat(3*i-2))
                  ENDIF
!
               ENDDO
               Ierror = 0
