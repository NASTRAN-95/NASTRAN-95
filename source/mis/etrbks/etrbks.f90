!*==etrbks.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL :: area , degra , determ , px2 , pxy2 , py2 , temp , theta , xbar , xbar3 , xbsq , xcsq , xcyc , ybar , ybar2 , ybar3 , ycsq
   REAL , DIMENSION(9) :: d , g , ti
...
!
   ...
   !>>>>EQUIVALENCE (Ielid,Ecpt(1),Necpt(1)) , (D(1),G(1),A(79)) , (Tjte(1),A(100)) , (Tite(1),S(1),A(82)) , (J2x2(1),A(92)) ,           &
!>>>>    & (Ti(1),A(118))
!
   DATA no/81 , 190/
   ntype = 0
