!*==strax1.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL :: aa , ajho , ajjho , area , c1 , c2 , c2s2 , c3 , c4 , cosg , cs , cs2 , degrad , del , dgama , dgamr , dr , er , et ,    &
         & ez , gor , grz , gzo , pi , r1 , r2 , r3 , ra , rh , rsum , s2 , s3 , s4 , sc2 , sing , tempe , vor , voz , vro , vrz ,  &
         & vzo , vzr , z1 , z2 , z3 , za , zdr , zmin , zsum
   REAL , DIMENSION(117) :: acurl
   REAL , DIMENSION(27) :: acurp1 , d1
   REAL , DIMENSION(9) :: acurp2 , d2
   REAL , DIMENSION(12) :: delint
   REAL , DIMENSION(63) :: ee
   REAL , DIMENSION(3,3) :: gababp , wjp
   INTEGER :: i , i1 , ib , ic , iki , ip , iq , j , ksave , matid , nogo
   INTEGER , DIMENSION(3) :: ics
   INTEGER , DIMENSION(35) :: iecpt
