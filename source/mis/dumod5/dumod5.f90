!*==dumod5.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   INTEGER :: buf1 , buf2 , core , half , half1 , i , i6or8 , ijk , input , is , itype , j , jb , je , jm , jsq , k , kk , kount ,  &
            & l , last , lj , loc , loca , locid , loop , m , neltp , newlt , nrop , nwds , nwds1 , nwds2 , nxir , nxzh , outpt ,   &
            & pv , retn , tapp , tapx , type
   INTEGER , DIMENSION(3) :: date
   LOGICAL , SAVE :: debug
   REAL*8 :: dtemp
   REAL*8 , SAVE :: dzero
   INTEGER , DIMENSION(2) , SAVE :: eg , mt , name , unvc
   REAL , SAVE :: epsi
   INTEGER , DIMENSION(5001) , SAVE :: id
   INTEGER , SAVE :: ie , ifirst , im , irdlmt , one , tape , xx , zero
   INTEGER , DIMENSION(2) :: infile , outfil
   INTEGER , DIMENSION(5001) :: ir
   INTEGER , DIMENSION(8) :: iz
   INTEGER , DIMENSION(7) :: mcb , trl
   LOGICAL :: none
   INTEGER , DIMENSION(2,5) , SAVE :: save
