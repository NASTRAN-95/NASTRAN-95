...
!
   ...
   REAL , DIMENSION(1) :: Dgpth
   REAL , DIMENSION(1) :: Aic
   REAL :: Th
   REAL :: Detjac
   REAL , DIMENSION(3) :: Shp
   REAL , DIMENSION(1) :: Bterms
   REAL , DIMENSION(1) :: Bmatrx
!
! Local variable declarations rewritten by SPAG
!
   REAL :: dnx , dny , eta , etai , psi , psii , shpf , xsi , xsii
   REAL , DIMENSION(3) :: dshpe , dshpx , tdshpe , tdshpx , tshp
   REAL , SAVE :: eps
   INTEGER :: i , i71 , i72 , i81 , i82 , i91 , i92 , ii , ip , ipt1 , ish , j , kk , nd1 , nd2 , nd3 , nd4 , nd5 , nd6 , nd7 ,     &
            & nd8 , nd9 , nnode
   REAL , DIMENSION(4) :: jacob
   REAL , DIMENSION(2,7) , SAVE :: ptint
   REAL , DIMENSION(2,3) , SAVE :: trc
...
!
   DATA eps/1.0E-13/
   DATA ptint/0.5 , 0.0 , 0.5 , 0.5 , 0.0 , 0.5 , 0.333333333333333D0 , 0.333333333333333D0 , 0.166666666666667D0 ,                 &
