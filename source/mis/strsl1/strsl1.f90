...
!
   REAL :: a , a1sq , a2sq , a3sq , b , c , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , d11 , d12 , d13 , d132 , d21 , d22 , &
         & d23 , d232 , d31 , d32 , d33 , d334 , det , determ , f , g11 , g12 , g13 , g22 , g23 , g33 , h4 , h5 , h6 , j11 , j12 ,  &
         & j22 , nsm , tbend1 , tbend3 , tbend5 , theta1 , thetam , thk , thk1 , tmem1 , tmem2 , tmem3 , tmem5 , tshr1 , tshr3 ,    &
         & tshr5 , x2 , x2y , x2y2 , x2y3 , x3 , x3y , x3y2 , x4 , x5 , xy , xy2 , xy3 , xy4 , y2 , y3 , y4 , y5
   REAL , SAVE :: blank , degra
   INTEGER :: i , i1 , i2 , i3 , idele , ii , ij , ij1 , ising , j , j1 , j2 , ji , jj , jst , kz , l , m , matid1 , matid2 ,       &
            & matid3 , mz
   ...
   REAL , DIMENSION(60) :: tmb
   REAL , DIMENSION(54) :: tmbq
   REAL , DIMENSION(3,12) :: tmm
   REAL , DIMENSION(36) :: tmmm
   EXTERNAL af , gmmats , invers , mat , strslv , transs , trif
!
