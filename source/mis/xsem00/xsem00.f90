!*==xsem00.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   INTEGER , DIMENSION(2) , SAVE :: equiv , purge , subnam , worde
   INTEGER :: errflg , error_id , fistnm , i , ibuf1 , idin , ierr , ifile , ii , iplot , itmbgn , j , j1 , j2 , j3 , j5 , kode ,   &
            & kscr , ktime , l , ldiag , ll , mm , modno , nin , nout , opntr , parml , parmn , plotf , typecd , vparml , vpsx
   INTEGER , SAVE :: exit , iblnk , modx , pool , xequ , xpur , xsav , ychk
