...
!
   REAL :: a1 , a2 , cosa1 , cosa2 , degra , del , djp1 , ep , et , phib , r1 , r2 , rp , s , sina1 , sina2 , tempe , tf , tm ,     &
         & twopi , vpt , vtp , z1 , z2
   REAL , DIMENSION(36) :: aki
   REAL , DIMENSION(66) :: delint
   REAL , DIMENSION(4) :: ee
   REAL , DIMENSION(144) :: gambl , gambq , gamrs
   REAL , DIMENSION(72) :: gambqf
   REAL , DIMENSION(48) :: gambqm
   INTEGER :: i , ip , itord , j , jp1 , k , kj , kk , kl , matid
   INTEGER , DIMENSION(2) :: ics
   INTEGER , DIMENSION(18) :: iecpt
   EXTERNAL amatrx , gmmats , mat , mesage , romber , scrlm , solve1 , transs
!
