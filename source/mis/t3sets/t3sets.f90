...
!
   ...
   REAL , DIMENSION(3) :: Dgpth
   REAL , DIMENSION(4,3) :: Egpdt
   REAL , DIMENSION(4,3) :: Gpnorm
   REAL , DIMENSION(4,3) :: Epnorm
   INTEGER , DIMENSION(3) :: Iorder
   REAL , DIMENSION(9) :: Teb
   REAL , DIMENSION(9) :: Tub
...
!
   REAL :: area2 , cc , length , small
   REAL , DIMENSION(3,3) :: axis
   REAL , DIMENSION(4,3) :: bgpdt
   REAL , DIMENSION(3) :: edg12 , edg13 , edg23 , tmpthk , x , y , z
   REAL , DIMENSION(9) :: ggu
