!*==crspld.f90 processed by SPAG 8.01RF 14:46  2 Dec 2023
!!SPAG Open source Personal, Educational or Academic User  NON-COMMERCIAL USE - Not for use on proprietary or closed source code
 
SUBROUTINE crspld(Jump,Mu,Bp,Rs,Again,N23) !HIDESTARS (*,Jump,Mu,Bp,Rs,Again,N23)
!
...
!
   REAL(REAL64) , DIMENSION(3) :: a , b , c
   REAL(REAL64) :: ans , di , espx , fac , len , leng , ln3
   ...
   LOGICAL , SAVE :: debug
   REAL(REAL64) , SAVE :: eps , half , one , zero
   REAL(REAL64) , DIMENSION(36) :: gnn , knn , snn , t , tx , unn , x , y , znn
   INTEGER , DIMENSION(2) :: mcode
   INTEGER , DIMENSION(2) , SAVE :: name
   INTEGER , DIMENSION(6) :: sild
   REAL(REAL64) , DIMENSION(6) :: w
   REAL , DIMENSION(1) :: z
   EXTERNAL bckrec , gmmatd , inverd , mesage , read , sswtch , transd , write
!
...
!
 ...
 60      X1 = z(k+1)
         ...
         spag_nextblock_1 = 13
         CYCLE SPAG_DispatchLoop_1
 80      CALL gmmatd(t,6,6,0,unn,6,6,0,x)
         IF ( pass==2 ) THEN
!
...
!
            ...
            CYCLE SPAG_DispatchLoop_1
         ENDIF
 140     CALL gmmatd(knn,6,6,0,t,6,6,0,tx)
!
...
!
         ASSIGN 200 TO retn3
         GOTO 420
 200     CALL gmmatd(unn,6,6,0,znn,6,6,0,snn)
!
!     SUM INTO KNN
!
...
!
         ASSIGN 240 TO retn3
         GOTO 420
 240     CALL gmmatd(unn,6,6,0,znn,6,6,0,snn)
...
!
         ASSIGN 260 TO retn3
         GOTO 420
 260     CALL gmmatd(unn,6,6,0,gnn,6,6,0,snn)
         i3 = Rs(ie)
         X3 = z(i3+1)
         Y3 = z(i3+2)
         Z3 = z(i3+3)
...
!
         ...
         spag_nextblock_1 = 14
         CYCLE SPAG_DispatchLoop_1
 280     CALL gmmatd(y,6,6,0,unn,6,6,1,znn)
...
!
         ...
         spag_nextblock_1 = 14
         CYCLE SPAG_DispatchLoop_1
 300     CALL gmmatd(gnn,6,6,0,unn,6,6,0,snn)
         ASSIGN 320 TO retn3
         GOTO 420
 320     DO j = 1 , 36
            y(j) = unn(j) - snn(j)
...
!
         ...
         spag_nextblock_1 = 13
         CYCLE SPAG_DispatchLoop_1
 340     CALL gmmatd(t,6,6,1,y,6,6,0,snn)
         CALL gmmatd(t,6,6,1,gnn,6,6,0,znn)
         ASSIGN 360 TO retn2
         zk = z(js)
         spag_nextblock_1 = 13
         CYCLE SPAG_DispatchLoop_1
 360     CALL gmmatd(snn,6,6,0,t,6,6,0,y)
         ASSIGN 380 TO retn2
         zk = z(i3)
         spag_nextblock_1 = 13
         CYCLE SPAG_DispatchLoop_1
 380     CALL gmmatd(znn,6,6,0,t,6,6,0,snn)
!
!     Y = G I 1  SNN = G I N
!
         ASSIGN 400 TO retn1
