!*==ofp1b.f90 processed by SPAG 8.01RF 16:18  2 Dec 2023
...
99081          FORMAT (46X,35HT E M P E R A T U R E   V E C T O R)
            ...
            ELSEIF ( local==90 ) THEN
               WRITE (l,99082)
99082          FORMAT (5X,9H    EL-ID,6X,2HS1,11X,2HS2,11X,2HS3,11X,2HS4,11X,2HS5,11X,2HS6,11X,2HS7,11X,2HS8,11X,2HS9)
            ELSEIF ( local==91 ) THEN
               WRITE (l,99083)
99083          FORMAT (5X,9H    EL-ID,6X,2HF1,11X,2HF2,11X,2HF3,11X,2HF4,11X,2HF5,11X,2HF6,11X,2HF7,11X,2HF8,11X,2HF9)
            ...
            ELSEIF ( local==102 ) THEN
               WRITE (l,99084)
99084          FORMAT (5X,9H     TIME,6X,2HS1,11X,2HS2,11X,2HS3,11X,2HS4,11X,2HS5,11X,2HS6,11X,2HS7,11X,2HS8,11X,2HS9)
            ELSEIF ( local==103 ) THEN
               WRITE (l,99085)
99085          FORMAT (5X,9H     TIME,6X,2HF1,11X,2HF2,11X,2HF3,11X,2HF4,11X,2HF5,11X,2HF6,11X,2HF7,11X,2HF8,11X,2HF9)
            ELSEIF ( local==104 ) THEN
               WRITE (l,99086)
99086          FORMAT (5X,9HFREQUENCY,6X,2HS1,11X,2HS2,11X,2HS3,11X,2HS4,11X,2HS5,11X,2HS6,11X,2HS7,11X,2HS8,11X,2HS9)
            ELSEIF ( local==105 ) THEN
               WRITE (l,99087)
99087          FORMAT (5X,9HFREQUENCY,6X,2HF1,11X,2HF2,11X,2HF3,11X,2HF4,11X,2HF5,11X,2HF6,11X,2HF7,11X,2HF8,11X,2HF9)
      ...
      CASE (2)
         ...
         ELSEIF ( local==2 ) THEN
            WRITE (l,99088)
99088       FORMAT (6X,'POINT ID.   TYPE',6X,'ID   VALUE     ID+1 VALUE    ',                                                       &
                   &'ID+2 VALUE     ID+3 VALUE     ID+4 VALUE     ID+5 VALUE')
         ELSEIF ( local==3 ) THEN
            WRITE (l,99089)
99089       FORMAT (19X,'F I N I T E   E L E M E N T   T E M P E R A T U R E','   G R A D I E N T S   A N D   F L U X E S')
         ELSEIF ( local==4 ) THEN
            WRITE (l,99090)
99090       FORMAT (4X,'ELEMENT-ID   EL-TYPE        X-GRADIENT       Y-','GRADIENT       Z-GRADIENT        X-FLUX           Y-FLUX',&
                   &'           Z-FLUX')
         ELSEIF ( local==5 ) THEN
            WRITE (l,99091)
99091       FORMAT (4X,'TIME         EL-TYPE        X-GRADIENT       Y-','GRADIENT       Z-GRADIENT        X-FLUX           Y-FLUX',&
                   &'           Z-FLUX')
         ELSEIF ( local==6 ) THEN
            WRITE (l,99092)
99092       FORMAT (26X,'ELEMENT-ID      APPLIED-LOAD       CONVECTION      ',' RADIATION           TOTAL')
         ELSEIF ( local==7 ) THEN
            WRITE (l,99093)
99093       FORMAT (26X,'TIME            APPLIED-LOAD       CONVECTION      ',' RADIATION           TOTAL')
         ELSEIF ( local==8 ) THEN
            WRITE (l,99094)
99094       FORMAT (33X,'H E A T   F L O W   I N T O   H B D Y   E L E M E N',' T S   (CHBDY)')
         ELSEIF ( local==9 ) THEN
            WRITE (l,99095)
99095       FORMAT (6X,16HTIME        TYPE,6X,7H  VALUE)
         ELSEIF ( local==10 ) THEN
            WRITE (l,99096)
99096       FORMAT (21X,'S T R E S S E S   I N   Q U A D R I L A T E R A L','   M E M B R A N E S      ( C Q D M E M 1 )')
         ELSEIF ( local==11 ) THEN
            WRITE (l,99097)
99097       FORMAT (14X,'C O M P L E X   S T R E S S E S   I N   Q U A D R I',                                                      &
                   &' L A T E R A L   M E M B R A N E S   ( C Q D M E M 1 )')
         ELSEIF ( local==12 ) THEN
            WRITE (l,99098)
99098       FORMAT (26X,'S T R E S S E S   A C T I N G   I N   Q D M E M 2  ',' E L E M E N T S   (CQDMEM2)')
         ELSEIF ( local==13 ) THEN
            WRITE (l,99099)
99099       FORMAT (19X,'C O M P L E X   S T R E S S E S   A C T I N G   I N','   Q D M E M 2   E L E M E N T S   (CQDMEM2)')
         ELSEIF ( local==14 ) THEN
            WRITE (l,99100)
99100       FORMAT (18X,'S T R E S S E S   I N   G E N E R A L   Q U A D R I',' L A T E R A L   E L E M E N T S',6X,                &
                   &15H( C Q U A D 4 ))
         ELSEIF ( local==15 ) THEN
            WRITE (l,99101)
99101       FORMAT ('0*** THIS FORMAT 809/OFP1B NOT USED ***')
         ELSEIF ( local==16 ) THEN
            WRITE (l,99102)
!                   ==============================
99102       FORMAT (28X,'F O R C E S   A C T I N G   O N   Q D M E M 2   E L',' E M E N T S   (CQDMEM2)')
         ELSEIF ( local==17 ) THEN
            WRITE (l,99103)
99103       FORMAT (20X,'C O M P L E X   F O R C E S   A C T I N G   O N   ','Q D M E M 2   E L E M E N T S   (CQDMEM2)')
         ELSEIF ( local==18 ) THEN
            WRITE (l,99104)
99104       FORMAT (18X,                                                                                                            &
...
99106       FORMAT (18X,                                                                                                            &
         ...
         ELSEIF ( local==21 ) THEN
            WRITE (l,99107)
99107       FORMAT (6X,16HSUBCASE     TYPE,10X,2HT1,13X,2HT2,13X,2HT3,13X,2HR1,13X,2HR2,13X,2HR3)
         ELSEIF ( local==22 ) THEN
            WRITE (l,99108)
99108       FORMAT (2(26X,7HMAXIMUM,8X,7HAVERAGE,6X,6HSAFETY),/2(6X,7HSUBCASE,14X,5HSHEAR,10X,5HSHEAR,7X,6HMARGIN))
         ELSEIF ( local==23 ) THEN
            WRITE (l,99109)
99109       FORMAT (20X,32HSTRESSES IN ELEMENT COORD SYSTEM,12X,9HPRINCIPAL,11X,18HPRINCIPAL STRESSES,10X,7HMAXIMUM,/6X,7HSUBCASE,  &
                  & 6X,8HNORMAL-X,6X,8HNORMAL-Y,7X,8HSHEAR-XY,6X,12HSTRESS ANGLE,9X,5HMAJOR,10X,5HMINOR,10X,5HSHEAR)
         ELSEIF ( local==24 ) THEN
            WRITE (l,99110)
99110       FORMAT (6X,7HSUBCASE,11X,3HSA1,12X,3HSA2,12X,3HSA3,12X,3HSA4,8X,12HAXIAL-STRESS,6X,6HSA-MAX,9X,6HSA-MIN,5X,6HM.S.-T,    &
                  & /24X,3HSB1,12X,3HSB2,12X,3HSB3,12X,3HSB4,26X,6HSB-MAX,9X,6HSB-MIN,5X,6HM.S.-C)
         ELSEIF ( local==25 ) THEN
            WRITE (l,99111)
99111       FORMAT (18X,                                                                                                            &
         ...
         ELSEIF ( local==26 ) THEN
            WRITE (l,99112)
99112       FORMAT (21X,17HBEND-MOMENT-END-A,12X,17HBEND-MOMENT-END-B,18X,5HSHEAR,/6X,7HSUBCASE,6X,3(7HPLANE 1,7X,7HPLANE 2,8X),    &
                   &6H FORCE,10X,6HTORQUE)
         ELSEIF ( local==27 ) THEN
            WRITE (l,99113)
99113       FORMAT (2(21X,5HAXIAL,7X,6HSAFETY,6X,9HTORSIONAL,5X,6HSAFETY),/2(6X,7HSUBCASE,7X,6HSTRESS,7X,6HMARGIN,8X,6HSTRESS,6X,   &
                   &6HMARGIN))
         ELSEIF ( local==28 ) THEN
            WRITE (l,99114)
99114       FORMAT (2(25X,5HAXIAL,30X),/2(6X,7HSUBCASE,12X,5HFORCE,9X,6HTORQUE,15X))
         ELSEIF ( local==29 ) THEN
            WRITE (l,99115)
99115       FORMAT (5X,7HELEMENT,8X,33HSTRESSES IN MATERIAL COORD SYSTEM,12X,9HPRINCIPAL,11X,18HPRINCIPAL STRESSES,12X,3HMAX)
         ELSEIF ( local==30 ) THEN
            WRITE (l,99116)
99116       FORMAT (13X,7HELEMENT,33X,'- STRESSES IN MATERIAL COORDINATE ','SYSTEM -',/15X,3HID.,18X,8HNORMAL-X,26X,8HNORMAL-Y,26X, &
                   &8HSHEAR-XY)
         ELSEIF ( local==31 ) THEN
            WRITE (l,99117)
99117       FORMAT (20X,33HSTRESSES IN MATERIAL COORD SYSTEM,11X,9HPRINCIPAL,11X,18HPRINCIPAL STRESSES,10X,7HMAXIMUM,/7X,4HTIME,8X, &
                   &8HNORMAL-X,6X,8HNORMAL-Y,7X,8HSHEAR-XY,6X,12HSTRESS ANGLE,9X,5HMAJOR,10X,5HMINOR,10X,5HSHEAR)
         ELSEIF ( local==32 ) THEN
            WRITE (l,99118)
99118       FORMAT (53X,42H- STRESSES IN MATERIAL COORDINATE SYSTEM -,/9X,9HFREQUENCY,18X,8HNORMAL-X,26X,8HNORMAL-Y,26X,8HSHEAR-XY)
         ELSEIF ( local==33 ) THEN
            WRITE (l,99119)
99119       FORMAT (20X,33HSTRESSES IN MATERIAL COORD SYSTEM,11X,9HPRINCIPAL,11X,18HPRINCIPAL STRESSES,10X,7HMAXIMUM,/6X,7HSUBCASE, &
                  & 6X,8HNORMAL-X,6X,8HNORMAL-Y,7X,8HSHEAR-XY,6X,12HSTRESS ANGLE,9X,5HMAJOR,10X,5HMINOR,10X,5HSHEAR)
         ELSEIF ( local==34 ) THEN
            idd = id(3) - 64
            WRITE (l,99120) idd
99120       FORMAT (21X,'S T R E S S E S   I N   I S O P A R A M E T R I C  ',' S O L I D   ( C I H E X',I2,2H ))
         ELSEIF ( local==35 ) THEN
            WRITE (l,99121)
99121       FORMAT (2X,7HELEMENT,5X,4HGRID,11X,'STRESSES IN BASIC COORDINATE','SYSTEM',13X,12HDIR. COSINES)
         ELSEIF ( local==36 ) THEN
            WRITE (l,99122)
99122       FORMAT (7X,2HID,4X,5HPOINT,8X,6HNORMAL,12X,5HSHEAR,10X,9HPRINCIPAL,10X,1HA,4X,1HB,4X,1HC,4X,11HMEAN STRESS,5X,          &
                   &9HMAX SHEAR)
         ELSEIF ( local==37 ) THEN
            idd = id(3) - 64
            WRITE (l,99123) idd
99123       FORMAT (13X,'C O M P L E X   S T R E S S E S   I N   I S O P A R',' A M E T R I C   S O L I D   ( C I H E X',I2,2H ))
         ELSEIF ( local==38 ) THEN
            WRITE (l,99124)
99124       FORMAT (7X,2HID,3X,6HPOINTS,5X,8HNORMAL-X,9X,8HNORMAL-Y,9X,8HNORMAL-Z,9X,8HSHEAR-XY,9X,8HSHEAR-YZ,9X,8HSHEAR-ZX)
         ELSEIF ( local==39 ) THEN
            WRITE (l,99125)
99125       FORMAT (25X,'F O R C E   D I S T R I B U T I O N   I N   B A R','   E L E M E N T S,10X,11H( C B A R )')
         ELSEIF ( local==40 ) THEN
            WRITE (l,99126)
99126       FORMAT (21H0    ELEMENT  STATION,9X,11HBEND-MOMENT,22X,11HSHEAR FORCE,21X,5HAXIAL)
         ELSEIF ( local==41 ) THEN
            WRITE (l,99127)
99127       FORMAT (7X,3HID.,5X,5H(PCT),5X,7HPLANE 1,8X,7HPLANE 2,11X,7HPLANE 1,8X,7HPLANE 2,15X,5HFORCE,14X,6HTORQUE)
         ELSEIF ( local==42 ) THEN
            WRITE (l,99128)
99128       FORMAT (25X,'S T R E S S   D I S T R I B U T I O N   I N   B A R','  E L E M E N T S,7X,11H( C B A R )')
         ELSEIF ( local==43 ) THEN
            WRITE (l,99129)
99129       FORMAT (21H0    ELEMENT  STATION,4X,3HSXC,11X,3HSXD,11X,3HSXF,11X,3HSXG,12X,5HAXIAL,10X,5HS-MAX,9X,5HS-MIN,9X,4HM.S.)
         ELSEIF ( local==44 ) THEN
            WRITE (l,99130)
99130       FORMAT (7X,3HID.,5X,5H(PCT))
         ELSEIF ( local==45 ) THEN
            WRITE (l,99131)
99131       FORMAT (21X,'F O R C E S  F O R  T H E  Q U A D R I L A T E R A L','  T H I N  S H E L L     ( C Q U A D T S )')
         ELSEIF ( local==46 ) THEN
            WRITE (l,99132)
99132       FORMAT (6X,2HEL,36X,6HFORCES,51X,7HMOMENTS)
         ELSEIF ( local==47 ) THEN
            WRITE (l,99133)
99133       FORMAT (6X,2HID,5X,5HPOINT,9X,2HFX,17X,2HFY,17X,2HFZ,17X,2HMX,17X,2HMY,17X,2HMZ)
         ELSEIF ( local==48 ) THEN
            WRITE (l,99134)
99134       FORMAT (17X,'F O R C E S   I N   T R I A N G U L A R   T H I N  ','S H E L L   E L E M E N T S   ( C T R S H L )')
         ELSEIF ( local==49 ) THEN
            WRITE (l,99135)
99135       FORMAT (19X,'S T R E S S E S  F O R  T H E  Q U A D R I L A T E ','R A L  T H I N  S H E L L     ( C Q U A D T S )')
         ELSEIF ( local==50 ) THEN
            WRITE (l,99136)
99136       FORMAT (3X,9HEL STRESS,8X,28HMEMBRANE  STRESS  RESULTANTS,24X,17HFLEXURAL  MOMENTS,27X,5HSHEAR)
         ELSEIF ( local==51 ) THEN
            WRITE (l,99137)
99137       FORMAT (3X,'ID  POINT   NORMAL(NX)     NORMAL(NY)     SHEAR(NXY)','     NORMAL(MX)     NORMAL(MY)     TORQUE(MXY)     ',&
                   &'NORMAL(QX)     NORMAL(QY)')
         ELSEIF ( local==52 ) THEN
            WRITE (l,99138)
99138       FORMAT (18X,'S T R E S S E S   I N   T R I A N G U L A R   T H I',' N   S H E L L   E L E M E N T S   ( C T R S H L )')
         ELSEIF ( local==53 ) THEN
            WRITE (l,99139)
99139       FORMAT (5X,'S T R E S S E S  I N  A X I S - S Y M M E T R I C  ',                                                       &
                   &'T R I A N G U L A R  R I N G  E L E M E N T S  (CTRIAAX)')
         ELSEIF ( local==54 ) THEN
            WRITE (l,99140)
99140       FORMAT (' ELEMENT   HARMONIC    POINT    RADIAL      AXIAL',6X,'CIRCUM.     SHEAR      SHEAR      SHEAR      F L U X   '&
                  & ,'D E N S I T I E S',/,' ID.       NUMBER      ANGLE     ',                                                     &
                   &'(R)         (Z)     (THETA-T)    (ZR)       (RT)       ','(ZT)        (R)        (Z)        (T)')
         ELSEIF ( local==55 ) THEN
            WRITE (l,99141)
99141       FORMAT (11X,'F O R C E S  I N  A X I S - S Y M M E T R I C  T R ','I A N G U L A R  R I N G  E L E M E N T S  (CTRIAAX)'&
                  & )
         ELSEIF ( local==56 ) THEN
            WRITE (l,99142)
99142       FORMAT (1X,                                                                                                             &
         ...
         ELSEIF ( local==57 ) THEN
            WRITE (l,99143)
99143       FORMAT (5X,'S T R E S S E S  I N  A X I S - S Y M M E T R I C  T',                                                      &
                   &' R A P E Z O I D A L  R I N G  E L E M E N T S  (CTRAPAX)')
         ELSEIF ( local==58 ) THEN
            WRITE (l,99144)
99144       FORMAT (11X,'F O R C E S  I N  A X I S - S Y M M E T R I C  T R ',                                                      &
                   &'A P E Z O I D A L  R I N G  E L E M E N T S  (CTRAPAX)')
         ELSEIF ( local==59 ) THEN
            WRITE (l,99145)
99145       FORMAT (43X,45HE L E M E N T   S T R A I N   E N E R G I E S)
         ELSEIF ( local==60 ) THEN
            WRITE (l,99146) id(6) , id(7) , fd(3)
99146       FORMAT (30X,15HELEMENT-TYPE = ,2A4,9X,23H* TOTAL FOR ALL TYPES =,1P,E16.7,/1H0,95X,1H*,/36X,10HELEMENT-ID,10X,          &
                   &13HSTRAIN-ENERGY,11X,16HPERCENT OF TOTAL)
         ELSEIF ( local==61 ) THEN
            WRITE (l,99147)
99147       FORMAT (42X,47HG R I D   P O I N T   F O R C E   B A L A N C E)
         ELSEIF ( local==62 ) THEN
            WRITE (l,99148)
99148       FORMAT (11H   POINT-ID,4X,10HELEMENT-ID,5X,6HSOURCE,13X,2HT1,13X,2HT2,13X,2HT3,13X,2HR1,13X,2HR2,13X,2HR3)
         ELSEIF ( local==63 ) THEN
            WRITE (l,99149)
99149       FORMAT (22X,'F O R C E S   I N   T R I A N G U L A R   P L A T E','  E L E M E N T S   ( C T R P L T 1 )')
         ELSEIF ( local==64 ) THEN
            WRITE (l,99150)
99150       FORMAT (20X,'S T R E S S E S   I N   T R I A N G U L A R   ','P L A T E   E L E M E N T S   ( C T R P L T 1 )')
         ELSEIF ( local==65 ) THEN
            WRITE (l,99151)
99151       FORMAT (1H0,9X,7HELEMENT,4X,5HPOINT,7X,2(11HBEND-MOMENT,9X),12HTWIST-MOMENT,2(11X,5HSHEAR,4X))
         ELSEIF ( local==66 ) THEN
            WRITE (l,99152)
99152       FORMAT (12X,3HID.,7X,3HNO.,13X,1HX,19X,1HY,39X,1HX,19X,1HY)
         ELSEIF ( local==67 ) THEN
            WRITE (l,99153)
99153       FORMAT (1H0,8H ELEMENT,2X,5HPOINT,5X,5HFIBER,11X,32HSTRESSES IN ELEMENT COORD SYSTEM,12X,                               &
                   &31HPRINCIPAL STRESSES (ZERO SHEAR),11X,3HMAX)
         ELSEIF ( local==68 ) THEN
            WRITE (l,99154)
99154       FORMAT (3X,3HID.,6X,3HNO.,5X,8HDISTANCE,7X,8HNORMAL-X,6X,8HNORMAL-Y,6X,8HSHEAR-XY,8X,5HANGLE,9X,5HMAJOR,9X,5HMINOR,10X, &
                   &5HSHEAR)
         ELSEIF ( local==69 ) THEN
            WRITE (l,99155)
99155       FORMAT (18X,'S T R E S S E S   I N   T R I A N G U L A R   ','M E M B R A N E   E L E M E N T S   ( C T R I M 6 )')
         ELSEIF ( local==70 ) THEN
            WRITE (l,99156)
99156       FORMAT (1H0,8H ELEMENT,5X,5HPOINT,7X,32HSTRESSES IN ELEMENT COORD SYSTEM,13X,31HPRINCIPAL STRESSES (ZERO SHEAR),13X,    &
                   &3HMAX)
         ELSEIF ( local==71 ) THEN
            WRITE (l,99157)
99157       FORMAT (4X,3HID.,8X,3HNO.,5X,8HNORMAL-X,7X,8HNORMAL-Y,7X,8HSHEAR-XY,8X,5HANGLE,10X,5HMAJOR,10X,5HMINOR,10X,5HSHEAR)
         ELSEIF ( local==72 ) THEN
            WRITE (l,99158)
99158       FORMAT (2(24X,6HMOMENT,9X,6HMOMENT,15X),/2(6X,7HSUBCASE,11X,7HPTS 1,3,8X,7HPTS 2,4,14X))
         ELSEIF ( local==73 ) THEN
            WRITE (l,99159)
99159       FORMAT (6X,7HSUBCASE,2X,2(11X,11HBEND-MOMENT),11X,12HTWIST-MOMENT,13X,5HSHEAR,17X,5HSHEAR,/31X,1HX,21X,1HY,43X,1HX,21X, &
                   &1HY)
         ELSEIF ( local==74 ) THEN
            WRITE (l,99160)
99160       FORMAT (4(6X,7HSUBCASE,9X,5HFORCE,6X))
         ELSEIF ( local==75 ) THEN
            WRITE (l,99161)
99161       FORMAT (5X,7HSUBCASE,11X,3HSA1,12X,3HSA2,12X,3HSA3,10X,12HAXIAL-STRESS,8X,6HSA-MAX,9X,6HSA-MIN,11X,6HM.S.-T,/23X,3HSB1, &
                  & 12X,3HSB2,12X,3HSB3,30X,6HSB-MAX,9X,6HSB-MIN,11X,6HM.S.-C)
         ELSEIF ( local==76 ) THEN
            WRITE (l,99162)
99162       FORMAT (2(54X,6HSAFETY),/2(5X,7HSUBCASE,14X,7HMAXIMUM,8X,7HAVERAGE,6X,6HMARGIN))
         ELSEIF ( local==77 ) THEN
            WRITE (l,99163)
99163       FORMAT (19X,5HFIBRE,11X,32HSTRESSES IN ELEMENT COORD SYSTEM,13X,31HPRINCIPAL STRESSES (ZERO SHEAR),10X,7HMAXIMUM,/5X,   &
                   &7HSUBCASE,6X,8HDISTANCE,7X,8HNORMAL-X,7X,8HNORMAL-Y,6X,8HSHEAR-XY,7X,5HANGLE,9X,5HMAJOR,11X,5HMINOR,10X,5HSHEAR)
         ELSEIF ( local==78 ) THEN
            WRITE (l,99164)
99164       FORMAT (4(6X,7HSUBCASE,8X,6HSTRESS,6X))
         ELSEIF ( local==79 ) THEN
            WRITE (l,99165)
99165       FORMAT (107X,22HOCTAHEDRAL    PRESSURE,/5X,10HSUBCASE   ,8X,8HSIGMA-XX,6X,8HSIGMA-YY,6X,8HSIGMA-ZZ,7X,6HTAU-YZ,8X,      &
                   &6HTAU-XZ,8X,6HTAU-XY,8X,5HTAU-0,10X,1HP)
         ELSEIF ( local==80 ) THEN
            WRITE (l,99166)
99166       FORMAT (107X,22HOCTAHEDRAL    PRESSURE,/5X,11HSUBCASE    ,8X,8HSIGMA-XX,6X,8HSIGMA-YY,6X,8HSIGMA-ZZ,7X,6HTAU-YZ,8X,     &
                   &6HTAU-XZ,8X,6HTAU-XY,8X,5HTAU-0,10X,1HP)
         ELSEIF ( local==81 ) THEN
            WRITE (l,99167)
99167       FORMAT (32X,'F O R C E S   O F   M U L T I - P O I N T   C O N S',' T R A I N T')
            WRITE (l,99168)
99168       FORMAT (1H )
         ELSEIF ( local==82 ) THEN
            WRITE (l,99169)
99169       FORMAT (2X,7HELEMENT,4X,16HMAT. COORD. SYS.,6X,33HSTRESSES IN MATERIAL COORD SYSTEM,12X,                                &
                   &31HPRINCIPAL STRESSES (ZERO SHEAR),12X,3HMAX)
         ELSEIF ( local==83 ) THEN
            WRITE (l,99170)
99170       FORMAT (4X,3HID.,6X,15HID./OUTPUT CODE,5X,8HNORMAL-X,7X,8HNORMAL-Y,6X,8HSHEAR-XY,7X,5HANGLE,9X,5HMAJOR,11X,5HMINOR,10X, &
                   &5HSHEAR)
         ELSEIF ( local==84 ) THEN
            WRITE (l,99171)
99171       FORMAT (43X,'S T R E S S E S   A T   G R I D   P O I N T S')
         ELSEIF ( local==85 ) THEN
            WRITE (l,99172)
99172       FORMAT (7X,'S T R A I N S / C U R V A T U R E S   I N   G E N E ','R A L   T R I A N G U L A R   E L E M E N T S',6X,   &
                   &'( C T R I A 1 )')
         ELSEIF ( local==86 ) THEN
            WRITE (l,99173)
99173       FORMAT (7X,'S T R A I N S / C U R V A T U R E S   I N   G E N E ','R A L   T R I A N G U L A R   E L E M E N T S',6X,   &
                   &'( C T R I A 2 )')
         ENDIF
         EXIT SPAG_DispatchLoop_1
      END SELECT
   ENDDO SPAG_DispatchLoop_1
99174 FORMAT (36X,'S T R E S S E S   I N   U S E R   E L E M E N T S','  (C',A4,1H))
99175 FORMAT (38X,'F O R C E S   I N   U S E R   E L E M E N T S   (C',A4,1H))
99176 FORMAT (28X,'C O M P L E X   S T R E S S E S   I N   U S E R   ','E L E M E N T S   (C',A4,1H))
99177 FORMAT (30X,'C O M P L E X   F O R C E S   I N   U S E R   E L E',' M E N T S   (C',A4,1H))
!
