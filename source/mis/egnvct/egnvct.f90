...
!
   INTEGER :: N
   COMPLEX , DIMENSION(N,N) :: C1
   COMPLEX , DIMENSION(N) :: C2
   COMPLEX :: Eigen
   COMPLEX , DIMENSION(N) :: C3
   INTEGER , DIMENSION(N) :: N1
   INTEGER , DIMENSION(N) :: N2
!
...
!
         DO j = 1 , N
            i1 = N2(j)
            SPAG_Loop_3_1: DO i = 1 , N
               IF ( i1==N1(i) ) EXIT SPAG_Loop_3_1
            ENDDO SPAG_Loop_3_1
            C2(j) = C3(i)
         ENDDO
!
