!*==fbsi4.f90 processed by SPAG 8.01RF 14:47  2 Dec 2023
...
!
   ...
   COMPLEX(REAL64) , DIMENSION(1) :: Y
   INTEGER , DIMENSION(2) :: Mem
   REAL(REAL64) , DIMENSION(2) :: Dmem
...
!
   ...
   INTEGER :: ifcol , ii , ij , ik , indxi , indxl , iopen , irow , iyrow , j , j1 , ji , k , kcol , last , lcol , ncol , nidlt ,   &
            & nrows
   COMPLEX(REAL64) :: ljj , sum , yjk
   COMPLEX(REAL64) , SAVE :: zero
