!*==gpstgs.f90 processed by SPAG 8.01RF 16:18  2 Dec 2023
...
!
   REAL , DIMENSION(9) :: b
   REAL :: const , det , dtol , fm , fr , temp
   REAL , DIMENSION(3) :: fl , m , r
...
!
                  ...
                  kount = 0
                  ipoint = 3
                  SPAG_Loop_1_1: DO WHILE ( b(ll)>0.0 )
                     nwds = nwds + 2
                     ttlwds = ttlwds + 2
                     IF ( ll<5 ) THEN
                        inc1 = 2
