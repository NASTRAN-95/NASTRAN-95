!*==ktshld.f90 processed by SPAG 8.01RF 14:46  2 Dec 2023
...
!
   REAL :: a , a1 , a2 , a3 , amass , b , c , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , dista , distb , distc , j11 , j12 ,&
         & j22 , nsm , tbend1 , tbend3 , tbend5 , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 , tshr , tshr1 ,     &
         & tshr3 , tshr5
   REAL(REAL64) :: a1sq , a2sq , a3sq , area , d11 , d12 , d13 , d132 , d22 , d23 , d232 , d33 , d334 , determ , g11 , g12 , g13 ,  &
                 & g22 , g23 , g33 , h4 , h5 , h6 , rho , rix , riy , rjx , rjy , rkx , rky , rlx , rly , rmnx , rmny , rmx , rmx1 ,&
                 & rmy , rmy1 , rnx , rnx1 , rny , rny1 , s11 , s13 , s22 , s23 , s33 , sb1 , sb10 , sb11 , sb12 , sb13 , sb14 ,    &
                 & sb15 , sb16 , sb17 , sb18 , sb19 , sb2 , sb20 , sb21 , sb22 , sb23 , sb24 , sb25 , sb26 , sb27 , sb28 , sb29 ,   &
                 & sb3 , sb30 , sb31 , sb32 , sb33 , sb34 , sb35 , sb36 , sb37 , sb38 , sb39
   REAL , SAVE :: blank
   ...
   REAL(REAL64) , DIMENSION(1024) :: kshl , mshl
   REAL(REAL64) , DIMENSION(36) :: ksup , ksupt
   ...
   REAL(REAL64) :: sb4 , sb40 , sb41 , sb5 , sb6 , sb7 , sb8 , sb9 , st , st1 , st11 , st121 , st122 , st131 , st132 , st133 ,      &
                 & st22 , st231 , st232 , st233 , st331 , st332 , vol
...
!
         ...
         unimem = .FALSE.
         uniben = .FALSE.
         IF ( abs(a2)<=1.0D-06 .AND. abs(a3)<=1.0D-06 ) uniben = .TRUE.
         IF ( abs(c2)<=1.0D-06 .AND. abs(c3)<=1.0D-06 ) unimem = .TRUE.
         a1sq = a1*a1
         a2sq = a2*a2
         a3sq = a3*a3
         c1 = a1sq*a1
                        ...
                        IF ( i>12 .OR. j<=12 ) THEN
                           IF ( i>12 ) THEN
                              ...
                              SPAG_Loop_3_1: DO k = 1 , 10
                                 ...
                                 IF ( uniben ) EXIT SPAG_Loop_3_1
                              ENDDO SPAG_Loop_3_1
                           ELSE
                              SPAG_Loop_3_2: DO k = 1 , 3
                                 ixr1 = ix1 + rk(k)
                                 jxs01 = jx01 + sk(k)
                                 lxs1 = lx1 + sk(k)
                                 kxr01 = kx01 + rk(k)
...
!
                        ...
                        SPAG_Loop_3_3: DO k = 1 , 3
                           ...
                           IF ( i<=12 ) sb41 = 0.0D0
                           st = st + sb1 + sb2 + sb4 + sb5 + sb7 + sb8 + sb9 + sb10 + sb11 + sb12 + sb13 + sb15 + sb16 + sb18 +     &
                              & sb19 + sb20 + sb21 + sb22 + sb23 + sb24 + sb26 + sb27 + sb28 + sb29 + sb30 + sb31 + sb32 + sb33 +   &
                              & sb34 + sb36 + sb37 + sb38 + sb39 + sb40 + sb41
                           IF ( unimem ) EXIT SPAG_Loop_3_3
                        ENDDO SPAG_Loop_3_3
                     ELSE
                        ix011 = ix01 + 1
                        jx011 = jx01 + 1
