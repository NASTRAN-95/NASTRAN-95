...
!
   REAL(REAL64) :: a , a2 , a3 , a4 , a5 , b , b2 , b3 , b4 , b5 , c , c2 , c23 , c3 , c4 , c5 , cep1 , cep2 , cepx , cepy , con ,  &
                 & d , d2 , d3 , d4 , d5 , e , ep , f , g , nuc , sa , t , temp , term , term1 , term2 , term3 , term4 , term5 ,    &
                 & x1 , x2 , x3 , x4 , xl , xl13 , xl24 , xp , y1 , y2 , y3 , y4 , yp , z
   ...
   REAL(REAL64) , DIMENSION(144) :: ke , kout , me , mout
   REAL(REAL64) , DIMENSION(9) :: ti
   REAL(REAL64) , DIMENSION(3) :: v12 , v41 , vd1 , vd2 , vi , vj , vk , vkn , vp12
   REAL(REAL64) , DIMENSION(6) :: vleft , vright
   EXTERNAL emadtq , emgout , gmmatd , mat , mesage , transd
!
