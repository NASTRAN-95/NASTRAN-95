...
!
   INTEGER :: etyp , file , gp , i , im1 , ipedge , ipen , is , itype , j , k , ls , lsmax , m , min , mm , n , nelsrf , ngpel ,    &
            & ngpelx , nn , nps1 , nps2 , npts , nwds , offset , solid
   LOGICAL :: hidden , shrink
   INTEGER , SAVE :: kae , kbar , kfhex1 , kfhex2 , kfteta , kfwedg , khx1 , khx2 , kis2d8 , kix1 , kix2 , kix3 , kq4 , kt3 , ktet ,&
                   & ktrim6 , ktrplt , ktrshl , kweg , letsz2 , nm1
   INTEGER , DIMENSION(9) , SAVE :: ldx , let9
   INTEGER , DIMENSION(229) :: let
   INTEGER , DIMENSION(5) , SAVE :: let1 , let7
   INTEGER , DIMENSION(4,4) , SAVE :: let2
   INTEGER , DIMENSION(5,5) , SAVE :: let3
   INTEGER , DIMENSION(5,6) , SAVE :: let4
   INTEGER , DIMENSION(9,6) , SAVE :: let5
   INTEGER , DIMENSION(13,6) , SAVE :: let6
   INTEGER , DIMENSION(7) , SAVE :: let8
   INTEGER , DIMENSION(3,9) , SAVE :: letsz
   INTEGER , DIMENSION(16) , SAVE :: m1
   INTEGER , DIMENSION(2) , SAVE :: name
   REAL :: shk , x1 , x2 , xc , y1 , y2 , yc , zc
   INTEGER , DIMENSION(27) :: temp
   EXTERNAL bckrec , close , fread , gopen , line , mesage , read , sort , sort2k , write , wrtprt
!
