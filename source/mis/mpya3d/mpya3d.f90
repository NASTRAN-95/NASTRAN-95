!*==mpya3d.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
      SPAG_Loop_2_1: DO id1 = 1 , Nrow , Band
         id2 = id1 + Band - 1
         IF ( id1>ia1 ) EXIT SPAG_Loop_2_1
!
         id11n = (id1-1)*Nrow
         DO id = id1 , id2
            jj = id11n
...
!
   ...
   DO ib = 1 , Nrow
      ia1 = ((ib-1)/Band+1)*Band
!
      SPAG_Loop_2_2: DO id1 = 1 , Nrow , Band
         id2 = id1 + Band - 1
         IF ( id1>ia1 ) EXIT SPAG_Loop_2_2
!
         id11n = (id1-1)*Nrow
         DO id = id1 , id2
            jj = id11n
