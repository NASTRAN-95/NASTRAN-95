!*==qdmm1s.f90 processed by SPAG 8.01RF 16:18  2 Dec 2023
...
!
   REAL :: at1 , at2 , at3 , at4 , cth1 , cth2 , cth31 , cth32 , cth41 , cth42 , d , dict5 , dlt1 , dlt2 , eta , f , fact , h , h1 ,&
         & hh , la , lb , lbd1 , lc , lcd1 , lcd2 , ld , ldd2 , magi , magj , magk , p , pi1 , pi2 , pi3 , pj1 , pj2 , pj3 , pk1 ,  &
         & pk2 , pk3 , q , sth1 , sth2 , sth31 , sth32 , sth41 , sth42 , tea , temp , theta , v , x12 , x13 , x14 , x21 , x23 ,     &
         & x24 , x31 , x34 , x41 , x42 , y21 , y31 , y34 , y3a , y41 , y42 , y4a , ysub4 , z21 , z31 , z41 , z42
   INTEGER , DIMENSION(9) :: dict
   REAL , DIMENSION(26) :: ecpt
   REAL , DIMENSION(2) :: eta01
   ...
   REAL , DIMENSION(4) :: mgg
   REAL :: o
   LOGICAL :: planar
   REAL , DIMENSION(144) :: tempar
   EXTERNAL emgout , gmmats , mat , mesage , sort , transs
!
...
99001 FORMAT (A25,' 3115, QDMM1S FINDS ELEMENT NO.',I9,' PRESENT IN A',' HEAT FORMULATION AND IS IGNORING SAME.')
      RETURN
   ELSE
      eta01(1) = 0.211324865
      eta01(2) = 0.788675135
...
!
            ...
            IF ( h1>=1.0E-2 ) WRITE (outpt,99002) uim , h1 , necpt(1)
99002       FORMAT (A29,' 3061, THE MEASURE OF NON-PLANARITY IS ',E13.5,' FOR ELEMENT NUMBER',I9)
            pj1 = pk2*pi3 - pk3*pi2
            pj2 = pk3*pi1 - pk1*pi3
            pj3 = pk1*pi2 - pk2*pi1
...
!
                     ...
                     lc = sqrt(x34**2+y34**2)
                     ld = sqrt(x14**2+y4a**2)
                     IF ( la==0. .OR. lb==0. .OR. lc==0. .OR. ld==0. ) THEN
                        j = 26
                     ELSE
!
