...
!
   REAL(REAL64) , DIMENSION(10,10) :: Gmat
   REAL(REAL64) , DIMENSION(7,7) :: Dmat
   REAL(REAL64) , DIMENSION(240) :: Bmat
   REAL(REAL64) , DIMENSION(1) :: Bmat1
   REAL(REAL64) , DIMENSION(1) :: Bmat2
   INTEGER :: Mattyp
   INTEGER :: Jcor
   REAL(REAL64) :: Wtk
!
...
!
   REAL(REAL64) , DIMENSION(240) :: dbm
   REAL(REAL64) , DIMENSION(3,3) :: dmat1
   REAL(REAL64) , DIMENSION(4,4) :: dmat2
