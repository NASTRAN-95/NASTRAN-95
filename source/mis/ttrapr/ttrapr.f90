...
!
   REAL , DIMENSION(4) :: alfb , r , ts , z
   REAL :: cosg , degra , del , dgama , dgamr , er , et , ez , grz , r1 , r2 , r3 , r4 , rmax , rmin , sing , tempe , twopi , tz ,  &
         & vrt , vrz , vtr , vtz , vzr , vzt , z1 , z2 , z3 , z4 , zmin
   REAL , DIMENSION(22) :: d
   REAL , DIMENSION(12) :: delint , tl
   REAL , DIMENSION(16) :: ee , hprim , teo
   REAL , DIMENSION(144) :: gambl
   REAL , DIMENSION(64) :: gambq
   REAL , DIMENSION(96) :: gamqs
   INTEGER :: i , i1 , icore , idel , ip , iq , ising , j , jj , jj1 , jj2 , k , kk , l , matid
   INTEGER , DIMENSION(4) :: ics , igp
   INTEGER , DIMENSION(24) :: iecpt
   INTEGER , DIMENSION(2) :: jrz
   REAL , DIMENSION(32) :: q
   REAL , DIMENSION(24) :: sp
   EXTERNAL gbtran , gmmats , invers , mat , mesage , rzints
!
