!*==twists.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL :: a , a2 , a3 , a4 , a5 , b , b2 , b3 , b4 , b5 , c , c2 , c23 , c3 , c4 , c5 , cep1 , cep2 , cepx , cepy , con , d , d2 , &
         & d3 , d4 , d5 , dict5 , e , ep , f , g , pa , sa , t , temp , term , term1 , term2 , term3 , term4 , term5 , v12dk , vjl ,&
         & vkl , vp12l , x1 , x2 , x3 , x4 , xl , xl13 , xl24 , xp , xq , y1 , y2 , y3 , y4 , yp , z
   REAL , DIMENSION(4) :: avec , p , smallu , smallv
   INTEGER , DIMENSION(11) :: dict
   INTEGER :: i , ij , ike , iout , ip , ip1 , ipvt , is , isort , it , ivlbeg , ivrbeg , j , js , jt , jt8 , k , korm , l , nuc
   INTEGER , DIMENSION(2) :: iecpt
