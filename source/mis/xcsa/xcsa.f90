!*==xcsa.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   INTEGER :: allon , altrbs , apprec , bnk , diag09 , dmapbs , drecsz , endcd , erralt , flags , flgwrd , i , i7 , icrdct , id ,   &
            & iday , idfist , imhere , imnth , irtn1 , irtn2 , irtn3 , isign , isize , itopx , iyear , j , jj , jk , jn , jnx , k , &
            & l , m7 , mask5 , maskhi , mhibyt , msgnum , n7 , ngino , nogo , nostup , nscr , nwpc , oldalt , reel , rstrt , s7 ,   &
            & test , timew , timex
   INTEGER , DIMENSION(2) :: alter , bgnal , cend , endal , iz
   INTEGER , SAVE :: altopn , appaer , appdmp , apphea , blank , both , dmend , dolsin , icold , idisk , ignore , ileft , inp9 ,    &
                   & intgr , ixdmap , iyes , lectt , mask , no , notalt , nsolnm , nsubs , numapp , optape , plot , prnt , ptape ,  &
                   & renter , soluf
   INTEGER , DIMENSION(4) , SAVE :: apptyp
   INTEGER , DIMENSION(9) :: delete
   INTEGER , DIMENSION(11) , SAVE :: diagx
   INTEGER , DIMENSION(1) :: dmapbf , iptdic
   INTEGER , DIMENSION(51) , SAVE :: ectt
   INTEGER , DIMENSION(19) , SAVE :: hdg
   INTEGER , DIMENSION(4) :: insert
   INTEGER , DIMENSION(2) , SAVE :: iufile , nxcsa , nxptdc , osolu , xalt
   INTEGER , DIMENSION(200) , SAVE :: outcrd
   INTEGER , DIMENSION(7,10) , SAVE :: solnm1 , solnm2
   INTEGER , DIMENSION(7,11) , SAVE :: solnm3
   INTEGER , DIMENSION(7,31) :: solnms
   INTEGER , DIMENSION(6) :: solnmx
