...
!
   REAL , DIMENSION(3) :: a1 , a2 , a3 , a4 , d1 , d2 , ivec , jvec , kvec
   REAL , DIMENSION(16) :: coord
   REAL :: cosang , h , sinang , tbar , theta , u1 , u2 , vecl
   REAL , DIMENSION(36) :: ecptsa
   INTEGER :: i , j , k , ncoord , npoint , nsub1 , nsub3
   INTEGER , DIMENSION(12) , SAVE :: m
   REAL , DIMENSION(4) :: ngrid
   REAL , DIMENSION(6) :: r
   REAL , DIMENSION(8) :: v
   EXTERNAL gmmats , mesage , trimem
!
