!*==ihexd.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL :: alfa , beta , bmag , dstld , maxar , smag , tmag
   ...
   REAL*8 :: detj , e1 , e2 , e3 , prt1 , sfact , sx , sxy , sy , syz , sz , szx , tvol
   ...
   REAL*8 , DIMENSION(45) :: store
   REAL*8 , DIMENSION(18) :: str
