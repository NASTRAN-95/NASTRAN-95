!*==tordrs.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
   REAL :: a1 , a2 , cosa1 , cosa2 , degrad , del , dict5 , djp1 , ep , et , phib , rp , s , sina1 , sina2 , twopi , vpt , vtp
   REAL , DIMENSION(144) :: ak , am , d , gambq , gamrs , kout , mout
   REAL , DIMENSION(36) :: aki , akm
   REAL , DIMENSION(66) :: delint
   INTEGER , DIMENSION(9) :: dict
   REAL , DIMENSION(9) :: ecpt
   REAL , DIMENSION(4) :: ee
   REAL , DIMENSION(72) :: gambqf
   REAL , DIMENSION(48) :: gambqm
   ...
   REAL , DIMENSION(2) :: r , z
   EXTERNAL dmatrs , emgout , gmmats , mat , mesage , rombsk , transs
!
