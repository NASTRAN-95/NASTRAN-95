!*==amgt1t.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
   REAL :: a1 , a2 , a3 , a4 , a5 , a6 , a7 , a8 , a9 , b1 , b2 , b3 , b4 , b5 , b6 , b7 , b8 , b9 , c1 , c2 , c3 , c4 , c5 , c6 ,  &
         & c7 , c8 , c9 , l1 , l2 , l3 , w1 , w2
   REAL , DIMENSION(3) :: data , f1 , fn , p1 , pn , s1 , sn
   INTEGER , SAVE :: file
...
!
         nskip = (2-Nstns)*3
         CALL read(*40,*20,Acpt,data,nskip,0,mm)
         CALL fread(Acpt,data,3,0)
         DO i = 1 , 3
            sn(i) = data(i)
         ENDDO
...
!
            CALL read(*40,*20,Acpt,data,-10,0,mm)
            CALL fread(Acpt,data,3,0)
            f1(1) = data(1)
            f1(2) = data(2)
            f1(3) = data(3)
