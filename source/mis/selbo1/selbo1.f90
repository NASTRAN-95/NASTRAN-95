!*==selbo1.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   ...
   REAL :: alphar , c2t , ct , dampc , determ , dum , fi1 , fi2 , fjk , fld , fll , l , r2 , ra , rb0 , rb1 , rt , rv1 , rv2 , s2t ,&
         & st , t , x
   REAL :: cod , dtr , sid
   REAL , SAVE :: dcr
   REAL , DIMENSION(6,6) :: df , f , h
   REAL , DIMENSION(20) :: dp
   REAL , DIMENSION(100) :: ecpt
   REAL , DIMENSION(6) :: hut , smalv0
   INTEGER :: i , i12 , iab , ic , icsida , icsidb , ig , ikel , in , index , ir , ising , isop , iwbeg , j , jcsid , jcsida ,      &
            & jcsidb , k , lim , low
   INTEGER , DIMENSION(100) :: iecpt
   REAL , DIMENSION(12,12) :: s
