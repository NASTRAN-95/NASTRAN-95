!*==mma403.f90 processed by SPAG 8.01RF 16:19  2 Dec 2023
...
!
!
!     MMA403 PERFORMS THE MATRIX OPERATION USING METHOD 40
!       IN COMPLEX SINGLE PRECISION
!       (+/-)A(T & NT) * B (+/-)C = D
!
!     MMA403 USES METHOD 40 WHICH IS AS FOLLOWS:
