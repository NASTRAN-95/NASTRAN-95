...
!
   REAL(REAL64) , DIMENSION(3) :: Ra
   REAL(REAL64) , DIMENSION(3) :: Rb
   REAL(REAL64) , DIMENSION(3) :: Rc
   REAL(REAL64) , DIMENSION(3) :: Alpha
   REAL(REAL64) :: Isinth
   REAL(REAL64) :: Icosth
   REAL(REAL64) , DIMENSION(9) :: Gsube
   REAL(REAL64) :: It
   INTEGER :: Ierror
   INTEGER :: Iopt
   REAL(REAL64) , DIMENSION(1) :: Kmat
   REAL(REAL64) , DIMENSION(1) :: Pmat
   REAL(REAL64) , DIMENSION(1) :: Smat
   REAL(REAL64) , DIMENSION(1) :: Zmat
!
! Local variable declarations rewritten by SPAG
!
   REAL(REAL64) , DIMENSION(3) :: alp , ivec , jvec , kvec , tm3 , v12 , v13
   REAL(REAL64) , DIMENSION(3,6) :: c
   REAL(REAL64) , DIMENSION(6) :: ca , cb , cc
   REAL(REAL64) , DIMENSION(9) :: e , hitge , temp9 , tm
   REAL(REAL64) , DIMENSION(27) :: hi
