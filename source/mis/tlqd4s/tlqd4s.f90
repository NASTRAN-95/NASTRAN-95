!*==tlqd4s.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   REAL :: aa , bb , bdum , c , c2 , cc , coeff , delta , deltat , determ , detg2 , detu , dum , elth , eta , exi , exj , gdum ,    &
         & matset , mintr , mominr , offset , pa , reali , s , s2 , sysbuf , tbar , tempel , tgrad , theta , thetae , thetam , thk ,&
         & ti , tlam , tmean , tsub0 , tsubo , ttbar , v12dk , vjl , vkl , vp12l , x31 , x42 , xi , xm , y31 , y42 , ym , zk , zk1 ,&
         & zoff , zoff1 , zref , zsubi , zta
   REAL , DIMENSION(6,6) :: abbd , g
   REAL , DIMENSION(3) :: alfab , alfam , alphae , alphal , cent , cente , galpha , talfab , talfam , thrmom , v12 , v41 , vd1 ,    &
                        & vd2 , vis , vjs , vkn , vks , vp12
   REAL , DIMENSION(6) :: alpha , alphad , alpham , epslnt , epsubt , ftherm , gepsbt , gtemps
   REAL , DIMENSION(3,4) :: bgpdm , ugpdm
   REAL , DIMENSION(4,4) :: bgpdt , egpdt , epnorm , gpnorm , tgrid
   REAL , DIMENSION(144) :: bmatrx
   LOGICAL :: compos , pcmp , pcmp1 , pcmp2 , tempp1 , tempp2
   REAL , SAVE :: const , eps1
   REAL , DIMENSION(4) :: dgpth , ecpt , gpth , shp , tmpshp , tmpthk
   ...
   REAL , DIMENSION(9) :: g2 , g2i , gbar , gge , ggu , glay , glayt , gt , jacob , phi , tbg , tbm , teb , tem , teu , transl ,    &
                        & tub , tum , u
   REAL , DIMENSION(36) :: gi , stiff , trans
