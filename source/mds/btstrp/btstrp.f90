!*==btstrp.f90  processed by SPAG 7.61RG at 01:00 on 21 Mar 2022
...
!
   INTEGER , SAVE :: abcd , imnth , iyr1 , iyr2 , ka , mvax , nmach
   INTEGER :: ak , i , idrum , intp , iprec , ldict , linkno , locf , lpch , mach , mask , nbpc , nbpw , ncpw , nlpp , order ,      &
            & outtap , qp , recl , sperlk , sysbuf
   CHARACTER(7) , DIMENSION(22) , SAVE :: compos
   CHARACTER(11) , DIMENSION(22) , SAVE :: comput
