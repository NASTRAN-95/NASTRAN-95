...
!
   ...
   INTEGER Ierr , Ipt
   LOGICAL Sheart
   REAL Aic(1) , Bmatrx(1) , Bterms(1) , Dgpth(1) , Egpdt(4,1) , Shp(3)
   INTEGER Iorder(3)
!
! Local variable declarations
!
   REAL dnx , dny , dshpe(3) , dshpx(3) , eps , eta , etai , jacob(4) , psi , psii , ptint(2,7) , shpf , tdshpe(3) , tdshpx(3) ,    &
      & trc(2,3) , tshp(3) , vi(2) , vj(2) , xsi , xsii
