...
SUBROUTINE t3gemd(Ierr,Egpdt,Iorder,Gb,Gs,Lx,Ly,Edglen,Shrflx,Aic,Jog,Jok,K11,K22)
   IMPLICIT NONE
   INTEGER Ierr
   DOUBLE PRECISION Jog , Jok , K11 , K22 , Lx , Ly
   LOGICAL Shrflx
   DOUBLE PRECISION Aic(18) , Edglen(3) , Egpdt(4,3) , Gb(9) , Gs(4)
   INTEGER Iorder(3)
   DOUBLE PRECISION aa(9) , bdum(3) , cosa , cosb , cosc , determ , h1 , h2 , sina , sinb , sinc , xx(3) , yy(3)
