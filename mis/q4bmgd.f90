...
SUBROUTINE q4bmgd(Dshp,Gpth,Bgpdt,Gpnorm,Phi,Bmatrx)
   IMPLICIT NONE
   DOUBLE PRECISION Anglei(4) , Detj , Edgel(4) , Edgshr(3,4) , Hzta , Psitrn(9) , Uev(3,4) , Unv(3,4)
   ...
   DOUBLE PRECISION Bmatrx(1) , Dshp(1) , Gpth(1) , Phi(9)
   DOUBLE PRECISION atrans(6) , bb1 , bb2 , bb3 , bbar(120) , bsbar(48) , bsbar1(6) , deriv , tee(9) , term , thick
