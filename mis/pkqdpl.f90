...
SUBROUTINE pkqdpl
   ...
   REAL Alp12 , Alpha1 , Alpha2 , Consts(5) , Cosang , Costh , Degra , Dum1(148) , Ecpt(100) , Eltemp , G11 , G12 , G13 , G22 ,     &
      & G23 , G2x211 , G2x212 , G2x222 , G33 , Gsube , Rho , Sigcom , Sigshe , Sigten , Sinang , Sinth , Sp1(28) , Sp2(2) , Stress ,&
      & Theta , Tsub0 , Vq1(3) , Vq2(3) , Vq3(3) , Vq4(3)
   INTEGER Inflag , Ising , Jnot , Km , Matid , Nbegin , Necpt(100) , Nogo , Npivot , Npoint , Npvt , Nsubc , Subsca , Subscb ,     &
         & Subscc
   ...
   COMMON /pla42d/ Kout , Tite , Tjte , Temp18 , Dpdum1 , Ivect , Jvect , Kvect , D1 , D2 , A1 , T , V , Vv , H , U1 , U2 , R ,     &
