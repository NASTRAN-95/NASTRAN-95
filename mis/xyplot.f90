...
!
   REAL All , Apo(2) , Axmax , Cch , Ccv , Chrscl , Clbl(32) , Cntpi , Cscale , Cvtl(32) , D1 , D2(2) , D3(37) , Papszx , Papszy ,  &
      ...
      & Yint , Ylow , Yltc , Ymax , Ymin , Ypap , Ytic , Yup , Ywmax , Z(20000)
   INTEGER D4(13) , Ibtc , Icmra , Icrv , Idmj , Idpe , Idsb , Ifskp , Ihalf , Iltc , Ipenn , Ipens , Ipltbf , Ipltnr , Ipsz ,      &
         & Iptdn , Irtc , Iskp , Itbf , Itp , Ittc , Ix(1) , Ixax , Ixdt , Ixgd , Ixpr , Ixvs , Iyax , Iydt , Iygd , Iypr , Iyvs ,  &
         & Jpsz(8) , Ksystm(65) , Logx , Logy , Ltape , Mach , Mnp , Model , Ncmr , Ncom , Ncrv , Nfrm , Nlines , Nlpp , Npens ,    &
         & Nplt , Nwfr , Nxdg , Nxtt , Nydg , Nytt , Outape , Sysbuf
   CHARACTER*25 Sfm , Uwm
   CHARACTER*27 Swm
   CHARACTER*23 Ufm
   CHARACTER*29 Uim
   COMMON /machin/ Mach , Ihalf
   COMMON /pltdat/ Model , Ipltnr , Xwmin , Ylow , Axmax , Yup , Xwmax , Ywmax , Xedge , Yedge , Xa , Chrscl , Xymax , Cntpi , Cch ,&
                 & Ccv , All , Mnp , Apo , Itp , Ltape
   COMMON /system/ Ksystm
   COMMON /xmssg / Ufm , Uwm , Uim , Sfm , Swm
   COMMON /xxparm/ Ipltbf , Icmra , Ifskp , Pnam1 , Pnam2 , Iptdn , Npens , Papszx , Papszy , Ptyp1 , Ptyp2 , Jpsz , Pc , Spare , Ya
   COMMON /xyplin/ Idsb , Nfrm , Ncrv , Idpe , Ncom , Idmj , Itbf , Nwfr , Iskp , D1 , Xmin , Xmax , Ymin , Ymax , Xtic , Xdtc ,    &
                 & Xltc , Nxdg , Ixpr , Nxtt , Ixvs , Ixdt , Ytic , Ydtc , Yltc , Nydg , Iypr , Nytt , Iyvs , Iydt , Ittc , Ibtc ,  &
...
!
   REAL dl , dtc , dx , dy , nums , oldx , oldy , r , rnum , s , t , t1 , t2 , tltv(22) , xc , xdr , xl , xlpap , xmaxs , xmins ,   &
      ...
      & yxtr
   INTEGER expo , i , iclsrw , icpen , ie , ifield , ifin , ill , iopn , ipchg , iplus , irdrw , isym(2) , itc , j , k , l , label ,&
         & lcmr , lem , lep , log , logxs , logys , lpltmd , lstep , lttn(10) , lttp(10) , mb1 , mb2 , mb3 , n , nact , ndg , nerr ,&
         & nitk , nrwd , ntt , xyplt
...
!     IF (NCMR .NE. LCMR  ) GO TO 925
      ELSEIF ( Xpap/=xlpap ) THEN
         WRITE (Outape,99002) Swm
99002    FORMAT (A27,' 998, XYPLOT PLOTTER OR FRAME MAY NOT CHANGE FOR ','LOWER FRAME.  XYPLOT ABANDONED.')
         GOTO 1300
...
!
 800  ifin = 1
   IF ( nact/=(nact/2)*2 ) THEN
      nact = nact - 1
      WRITE (Outape,99003) Uwm , Nfrm , Ncrv
99003 FORMAT (A25,' 993, XYPLOT FOUND ODD NR. OF VALUES FOR DATA PAIRS',' IN FRAME',I5,', CURVE NR.',I5,'.  LAST VALUE IGNORED.')
      Nlines = Nlines + 2
...
!
      WRITE (Outape,99004) Uwm , n , Nfrm
99004 FORMAT (A25,' 997, NR.',I4,'.  FRAME NR.',I5,' INPUT DATA ','INCOMPATIBLE.  ASSUMPTIONS MAY PRODUCE INVALID PLOT.')
      Nlines = Nlines + 2
      IF ( Nlines>=Nlpp ) CALL page
      IF ( n/=1 ) EXIT
   ENDDO
...
!
 1100 RETURN
 1200 WRITE (Outape,99005) Uwm , Ltape
99005 FORMAT (A25,' 994, XYPLOT OUTPUT FILE NAME ',A4,' NOT FOUND.','  XYPLOT ABANDONED.')
