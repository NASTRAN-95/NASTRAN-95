...
SUBROUTINE trplt(Ti)
   ...
   REAL A(45) , C1 , C2 , Consts(5) , Cosang , Costh , D(9) , D1(3) , D2(3) , Degra , Determ , Dum10 , Dum11 , Dum12(4) , Dum8 ,    &
      ...
      & T(9) , Temp , Temp1 , Temp2 , Temp9(9) , Theta , Tite(10) , U1 , U2 , V(25) , V1(3) , V2(3) , V3(3) , Vv1(2) , Vv2(2) , X1 ,&
      & X2 , Xc , Xsubb , Xsubc , Y1 , Y2 , Yc , Ysubc , Z(1)
   INTEGER Inflag , Ising , Km , Matid , Necpt(25) , Npoint , Nsubc , Subsca , Subscb , Subscc
   COMMON /condas/ Consts
   COMMON /matin / Matid , Inflag , Eltemp , Stress , Sinth , Costh
   COMMON /ssgtri/ D , Khi , Ks , P
   COMMON /ssgwrk/ A , T , S , Hinv , Prod12 , D1 , D2 , Habc , Ssum , R , Ivect , Jvect , Kvect , Vv1 , Vv2 , Xsubb , Xsubc ,      &
