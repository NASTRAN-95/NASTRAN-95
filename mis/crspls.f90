...
!
 ...
 600  X1 = Z(k+1)
   ...
   zk = Z(k)
   GOTO 3200
 700  CALL gmmats(t,6,6,0,unn,6,6,0,x)
   IF ( pass==2 ) THEN
!
...
!
      ...
      GOTO 3200
   ENDIF
 1200 CALL gmmats(knn,6,6,0,t,6,6,0,tx)
!
...
!
   ...
   GOTO 3300
 1800 CALL gmmats(unn,6,6,0,znn,6,6,0,snn)
!
!     SUM INTO KNN
!
...
!
   ...
   GOTO 3300
 2200 CALL gmmats(unn,6,6,0,znn,6,6,0,snn)
...
!
   ...
   GOTO 3300
 2300 CALL gmmats(unn,6,6,0,gnn,6,6,0,snn)
   i3 = Rs(ie)
   X3 = Z(i3+1)
   Y3 = Z(i3+2)
   Z3 = Z(i3+3)
...
!
   ...
   unn(17) = A(1) - C(1)
   GOTO 3400
 2400 CALL gmmats(y,6,6,0,unn,6,6,1,znn)
...
!
   ...
   unn(17) = B(1) - C(1)
   GOTO 3400
 2500 CALL gmmats(gnn,6,6,0,unn,6,6,0,snn)
...
!
   ...
   zk = Z(i2)
   GOTO 3200
 2700 CALL gmmats(t,6,6,1,y,6,6,0,snn)
   CALL gmmats(t,6,6,1,gnn,6,6,0,znn)
   ASSIGN 2800 TO retn2
   zk = Z(js)
   GOTO 3200
 2800 CALL gmmats(snn,6,6,0,t,6,6,0,y)
   ASSIGN 2900 TO retn2
   zk = Z(i3)
   GOTO 3200
 2900 CALL gmmats(znn,6,6,0,t,6,6,0,snn)
!
!     Y = G I 1  SNN = G I N
!
