...
!
   DOUBLE PRECISION acurl(208) , acurp1(48) , acurp2(16) , ajho , ajjho , ak(144) , akj(256) , akph2(16) , akt(27) , akuph(48) ,    &
                  ...
                  & teo(45) , v , vr , vz , z(4) , zmin
   REAL c3 , cs , cs2 , dict5 , gor , s3 , sc2
   INTEGER dict(14) , i , i1 , iai , iakt , iapp , ib , ic , ic1 , ics(4) , idel1 , idel2 , ik , ika , ikc , ikj , ikja , ikjb ,    &
         & ikjc , ip , ipart(4) , ipp , iq , ir1 , irc , ising , isort , it , j , jax , jt , k , kk , korm , ksave , l , masor ,    &
         & mjho
