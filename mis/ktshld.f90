...
!
   REAL Alf(3) , C1 , C10 , C2 , C3 , C4 , C5 , C6 , C7 , C8 , C9 , Cc(10) , Costh , Dumy(12) , Eltemp , Em(6) , Est(100) , F(14,14)&
      ...
      & Xc(6) , Yc(6) , Zc(6)
   DOUBLE PRECISION Balotr(36) , Cab(3) , Csub(5,5) , Csubt(6,5) , Ee(30) , Ksub(6,6) , Ksubt(6,6) , Ksup(36) , Ksupt(36) , Q(6,6) ,&
                  & Trand(9)
...
!
   ...
   DOUBLE PRECISION a1sq , a2sq , a3sq , area , cm1(30,30) , cms(900) , cmt(1296) , ctm(36,36) , d11 , d12 , d13 , d132 , d22 ,     &
                  & d23 , d232 , d33 , d334 , degra , determ , g11 , g12 , g13 , g22 , g23 , g33 , h4 , h5 , h6 , kshl(1024) ,      &
                  & mshl(1024) , qks(960) , qqq(20,20) , qqqinv(360) , rho , rix , riy , rjx , rjy , rkx , rky , rlx , rly , rmnx , &
                  & rmny , rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny , rny1 , s11 , s13 , s22 , s23 , s33 , sb1 , sb10 , sb11 ,    &
                  & sb12 , sb13 , sb14 , sb15 , sb16 , sb17 , sb18 , sb19 , sb2 , sb20 , sb21 , sb22 , sb23 , sb24 , sb25 , sb26 ,  &
                  & sb27 , sb28 , sb29 , sb3
   ...
   INTEGER lxs1 , ly , m , matid1 , matid2 , matid3 , mx , mx0 , mx01 , mx011 , mx0x , mx1 , mx1x , mx2 , mx2x , mx3 , mx3x ,       &
         & mxiyr , mxiyr1 , mxkyr , mxkyr1 , mxmyr1 , mxp1 , my , my1 , my1x , ndof , nsq , nx , nx0 , nx01 , nx011 , nx0y , nx1 ,  &
         & nx1y , nx2 , nx2y , nx3 , nx3y , nxjys , nxjys1 , nxlys , nxlys1 , nxnys1 , nxp1 , ny , ny1 , ny1y , rk(3) , sil1 ,      &
         & sil2 , sk(3) , xthk(10) , xu(32) , xv(32) , xw(32) , ythk(10) , yu(32) , yv(32) , yw(32)
