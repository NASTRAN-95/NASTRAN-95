...
!
   REAL aic(1) , avgthk , bmatrx(162) , bterms(6) , cente(3) , detjac , dgpth(3) , dpe(3,3) , edglen(3) , egpdt(4,3) , epnorm(4,3) ,&
      & gpnorm(4,3) , locate(3) , lx , ly , nv(3) , nvx(3) , p , pe(3,3) , ppp(3) , shp(3) , teb(9) , th , tub(9) , unv(3) , v3t(3) &
      & , weight , x
