...
SUBROUTINE kconed
   ...
   DOUBLE PRECISION A , B , Constd(5) , Cp , Cp2 , Cp2e22 , Cpe12 , Cpe22 , D11 , D12 , D22 , D33 , Dl , E11 , E12 , E22 , E33 ,    &
                  ...
                  & I44 , I52 , I53 , I54 , I62 , I63 , I64 , Integ(28) , Kij(36) , L2 , N , N2 , N2e22 , N2e33 , Ncp , Nsp , Opi , &
                  & Oq , Pi , Piovb , Ra , Rasq , Rb , Rbsq , Sign , Sl , Sp , Sp2 , Sp2e22
   REAL Costh , Dodet , Dum(5) , Dum1(10) , Dum2 , Dumcl(7) , Ecpt(100) , Eltemp , G , G11 , G12 , G13 , G22 , G23 , G33 , Gsube ,  &
      & Sinth , Stress
   INTEGER Idetck , If4gg , Ifkgg , Inflag , Iopt4 , K4ggsw , Link(10) , Matid , Matid1 , Matid2 , Matid3 , Necpt(100) , Nogo , Npvt
   DOUBLE PRECISION Sp2e33 , Spe12 , Spe22 , Spe33 , T , Td , Temp , Temp1 , Temp2 , Temp3 , Temp4 , Temp5 , Temp6 , Temp60(60) ,   &
                  & Temp7 , Tn , Tnsp , Ts , Twod33 , Za , Zb
...
!
!
   !>>>>EQUIVALENCE (Constd(1),Pi) , (Ecpt(4),Matid1) , (Ecpt(6),Matid2) , (Ecpt(8),Matid3) , (Ecpt(1),Necpt(1))
...
!
 700  kqx(1,1) = kqx(1,1) + Cp*Cp*I04*(+D22*N**2+2.25D0*D33*Sp**2)
   ...
   kqx(6,6) = kqx(6,6) + N*N*(Sp*(I13*(D22*(-2.0D0)+D33*(-8.0D0))+D33*Sp*I24*4.0D0)+D22*N**2*I24+4.0D0*D33*I02) + D22*Sp*Sp*I02
   ...
   kqx(7,7) = kqx(7,7) + N*N*(Sp*(I33*(D22*(-4.0D0)+D33*(-1.6D01))+D33*Sp*I44*4.0D0)+I22*(D12*(-4.0D0)+D33*1.6D01)+D22*N*N*I44)     &
            & + Sp*(D12*I11*8.0D0+D22*Sp*I22*4.0D0) + D11*I00*4.0D0
   kqx(7,8) = kqx(7,8) + N*N*(Sp*(I43*(D22*(-5.0D0)+D33*(-2.0D01))+D33*Sp*I54*4.0D0)+I32*(D12*(-8.0D0)+D33*2.40D01)+D22*N*N*I54)    &
            & + Sp*(D12*I21*1.80D01+D22*Sp*I32*6.0D0) + D11*I10*1.20D01
   ...
   kqx(8,8) = kqx(8,8) + N*N*(Sp*(I53*(D22*(-6.0D0)+D33*(-2.40D01))+D33*Sp*I64*4.0D0)+I42*(D12*(-1.20D01)+D33*3.60D01)+D22*N*N*I64) &
            & + Sp*(D12*I31*3.60D01+D22*Sp*I42*9.0D0) + D11*I20*3.60D01
...
!
      ...
      kqx(1,3) = kqx(1,3) + N*(D33*(Cp*I03*(+1.5D0*Sp*H13-5.0D-1*N*H11)+N*H11*H13*I02)+D22*Cp*Sp*H13*I03) + D22*Sp*Sp*H11*H13*I02
      ...
      kqx(2,5) = kqx(2,5) + N*(D33*(H15*(Cp*(+1.5D0*Sp*I13-1.5D0*I02)+N*H12*I02)+Sp*N*H12*I03*2.0D0)+D22*Sp*(+Cp*H15*I13+N*H12*I03))&
      ...
      kqx(3,5) = kqx(3,5) + N*N*(D33*(H13*(+2.0D0*Sp*I03+H15*I02)+Cp*H15*I03*(-5.0D-1))+D22*Sp*H13*I03) + D22*Sp*Sp*H13*H15*I02
      ...
      kqx(4,5) = kqx(4,5) + N*N*(D33*(H14*(+2.0D0*Sp*I03+H15*I02)+Cp*H15*I13*(-5.0D-1))+D22*Sp*H14*I03) + D22*Sp*Sp*H14*H15*I02
!
...
!
      ...
      kqx(6,7) = kqx(6,7) + Sp*(D22*(Sp*(H16*(-2.0D0*I12+H17*I02)+H17*I02*(-1.0D0))+N*N*(+H17*I13+H16*I23))                         &
               & +D33*N*N*(+2.0D0*H17*I13+2.0D0*H16*I23)+D12*H16*I01*(-2.0D0)) + D33*N*N*(H16*(-4.0D0*I12+H17*I02)+H17*I02*(-2.0D0))
      kqx(6,8) = kqx(6,8) + Sp*(D22*(Sp*(H16*(-3.0D0*I22+H18*I02)+H18*I02*(-1.0D0))+N*N*(+H18*I13+H16*I33))                         &
               & +D33*N*N*(+2.0D0*H18*I13+2.0D0*H16*I33)+D12*H16*I11*(-6.0D0)) + D33*N*N*(H16*(-6.0D0*I22+H18*I02)+H18*I02*(-2.0D0))
      ...
      kqx(7,9) = kqx(7,9) + Sp*(H19*(D22*(Sp*(+H17*I02-2.0D0*I12)+N*N*I23)-2.0D0*D12*I01+2.0D0*D33*N**2*I23)+N*H17*I02*(+D22+D33))  &
               & + D33*N*N*H19*(-4.D0*I12+H17*I02)
      ...
      kqx(8,9) = kqx(8,9) + Sp*(H19*(D22*(Sp*(+H18*I02-3.0D0*I22)+N*N*I33)-6.0D0*D12*I11+2.0D0*D33*N**2*I33)+N*H18*I02*(+D22+D33))  &
               & + D33*N*N*H19*(-6.D0*I22+H18*I02)
