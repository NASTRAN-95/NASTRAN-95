...
SUBROUTINE stri32
   ...
   REAL Alfab(3) , Alfam(3) , App(2) , Avgthk , Delta(39) , Deltat(6) , Detg2 , Disp(1) , Dumm(30) , Dummy(35) , Epscmi(6,4) ,      &
      ...
      & , Tsub0 , U(36) , Uem(9) , Ues(9) , Ves(4) , Vxvy(2) , Z12(2,4) , Z1o , Z2o
   INTEGER Comps , Device , Elid , Extrnl(6) , Flag , Idr(3) , Idum(2) , Idumal , Igrid(4) , Indxg2(3,3) , Iorder(3) , Ipcmp ,      &
         & Ipcmp1 , Ipcmp2 , Ipid , Ivec , Ivecn , Iz1o , Iz2o , Kforc , Ksdrde(200) , Ksil(3) , Kstrn , Kstrs , Ldtemp , Mominr ,  &
         & Nepsop , Npcmp , Npcmp1 , Npcmp2 , Nstrop , Oef1l , Oes1al , Oes1l
   LOGICAL Forreq , Grids , Gridss , Layer , Layers , Ostrai , Stnreq , Strcur , Stsreq , Temper , Tempp1 , Tempp2 , Vonms , Vonmss
   ...
   COMMON /sdr2x7/ Elid , Ksil , Iorder , Tsub0 , Z1o , Z2o , Ipid , Idumal , Ph1rst
   COMMON /sdr2x8/ Extrnl , Igrid , Idr , Indxg2 , Thikns , Z12 , Delta , Deltat , Tdelta , G2 , U , Stempd , Epsln , Epslnm ,      &
                 & Epslnt , Vxvy , Epscsi , Epsusi , Qveci , Epscmi , Epsumi , Tes , Ues , Ves , Uem , G2alfb , Gdum , Detg2 ,      &
                 & T3ov12 , Offset , Tbar
