...
!
   REAL Costh , Deps , Depss , Dum(297) , Dum1 , Dumcl(145) , Dummy(64) , Ecpt(21) , Ecptsa(100) , Elid , Eltemp , Eps0 , Eps1 ,    &
      & Eps2 , Epss , Estar , Esub0 , Extra(4) , F , G11 , G12 , G13 , G22 , G23 , G33 , Gamma , Gammas , Gp(9) , Nu , Ph1out(200) ,&
      & Plaans , Plaarg , S(3) , Sigxs , Sigxys , Sigys , Sinth , Sx , Sy , Tau0 , Tau1 , Tau2 , Ui(9) , Z(24)
   INTEGER Idum2 , Idum3(3,3) , Inflag , Ipass , Ivec , Matid , Midgp , Necpt(21) , Necpts(21) , Nirof , Nogo , Npvt
...
! End of declarations
!
!  THIS SUBROUTINE IS THE DRIVER FOR THE  TRI-MEMBRANE CALCULATIONS IN
!  PLA4
!
!
!     ECPT LIST
