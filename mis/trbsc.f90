...
!
   REAL A(225) , Alp12 , Alpha1 , Alpha2 , Angle , Area , Consts(5) , Costh , D(9) , Degra , Determ , Dum55(1) , Dumdum(4) ,        &
      ...
      & Py2 , Rho , S(18) , Sigcom , Sigshe , Sigten , Sinth , Stress , T(9) , T2 , Temp , Temp9(9) , Theta , Tite(18) , Tsub0 ,    &
      & X1 , X2 , X3 , Xbar , Xbar3 , Xbsq , Xc , Xc3 , Xcsq , Xcyc , Xsubb , Xsubc , Y1 , Y2 , Y3 , Ybar , Ybar2 , Ybar3 , Yc ,    &
      & Yc2 , Yc3 , Ycsq
   INTEGER Inflag , Ising , Isub , Matid , Matid1 , Matid2 , Nbegin , Necpt(1) , Nerror , Ngrid(3) , Npivot , Nsized , Nsubc ,      &
         & Ntyped , Subsca , Subscb
   REAL Ysubc , Z(1) , Z1 , Z11 , Z2 , Z22 , Z3
   ...
   COMMON /ssgwrk/ A , Xsubb , Xsubc , Ysubc , E , Temp , Xbar , Area , Xcsq , Ybar2 , Ycsq , Ybar , Xbsq , Px2 , Xcyc , Py2 ,      &
