...
SUBROUTINE tlodsl(Treal,Tint)
   ...
   REAL a , a1 , a1sq , a2 , a2sq , a3 , a3sq , aa1 , aa2 , aa3 , area , aviner , avthk , b , balotr(36) , blank , c , c1 , c10 ,   &
      ...
      & g23 , g33 , g33pr , ge1(9) , gm1 , gm2 , gm3 , h4 , h5 , h6 , ivect(3) , jvect(3) , kvect(3) , name(2) , p8(5) , p9(6) ,    &
      & pl(3) , ptem(32) , ptemp , q(6,6) , qq(960) , qqq(20,20) , qqqinv(360) , rix
   INTEGER i , i1 , i2 , i3 , ics(6) , idele , ii , ij , ij1 , ik , index(20,3) , ising , ix , ixp1 , ixr , ixrt , ixrt1 , j , jj , &
         & jx , jxp1 , jxs , jxsu , jxsu1 , k , k1 , k2 , kx , kxp1 , kxr , kxrt , kxrt1 , l , lx , lxp1 , lxs , lxsu , lxsu1 , m , &
         & matid1 , matid2 , matid3 , mkr1 , mx , mx01 , mx01x , mx01xp , mx1 , mx1x , mx1xp , mxp1 , mxx , mxxp , nl(6) , nls1 ,   &
         & nsm , nx , nx01 , nx01y , nx01yq , nx1 , nx1y , nx1yq , nxp1 , nxy , nxyq , pt(3) , qt(3) , rk(3) , sil1 , sk(3) ,       &
         & small(6) , tl(3) , ul(3) , xthk(10) , xu(32) , xv(32) , xw(32) , ythk(10) , yu(32)
...
99001       FORMAT (A23,' 2417, A SINGULAR MATERIAL MATRIX FOR ELEMENT ID =',I9,' HAS BEEN DETECTED BY SUBROUTINE TLODSL',/26X,     &
                   &'WHILE',' TRYING TO COMPUTE THERMAL LOADS WITH TEMPP2 CARD DATA.')
            nogo = .TRUE.
            GOTO 99999
         ELSE
