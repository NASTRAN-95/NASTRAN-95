...
SUBROUTINE desvel
   ...
   CHARACTER*29 Uim
   CHARACTER*25 Uwm
   COMMON /blank / Gg , Vel1 , Vel2 , Vel3 , Vela , Velb , Velc , Acc1 , Acc2 , Acc3 , Acca , Accb , Accc , Accd
...
!
   ...
   CALL unpack(*100,omega,Z(ntot+1))
   GOTO 200
 100  DO i = 1 , Nnn
      Z(ntot+i) = 0.
   ENDDO
!
 200  CALL close(omega,1)
   nmodes = nrow
   ndir = ncol
!
