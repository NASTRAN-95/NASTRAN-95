...
SUBROUTINE bard
   ...
   REAL A , Alpha , C1 , C2 , Costh , D1 , D2 , Dum(12) , E , Ecpt(42) , Elid , Eltemp , F1 , F2 , Fe , Fj , Fk , G , G1 , G2 ,     &
      ...
      & Tsubo , Za(3) , Zb(3)
   DOUBLE PRECISION Dela(6) , Delb(6) , Ke(144) , Kep(144) , Kk(144) , M(12,12) , Me(144) , Mep(144) , Smalvn(6) , Ta(18) , Tb(9) , &
                  & Vec(10) , Veci(3) , Vecj(3) , Veck(3)
   ...
   COMMON /emgest/ Ielid , Isilno , Smalv , Icssv , Ipinfl , Za , Zb , Imatid , A , I1 , I2 , Fj , Nsm , Fe , C1 , C2 , D1 , D2 ,   &
...
!
 700  const = (fl*(dble(Rho)*dble(A)+dble(Nsm)))/420.D0
