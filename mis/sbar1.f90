...
SUBROUTINE sbar1
   ...
   INTEGER Icssv , Iecpt(100) , Ielid , Imatid , Ipinfl(2) , Isilno(2) , Jelid , Jsilno(2) , Matflg , Matidc , Mcsida , Mcsidb , Nu
   COMMON /matin / Matidc , Matflg , Eltemp , Stress , Sinth , Costh
   COMMON /matout/ E , G , Nu , Rho , Alpha , Tsub0 , Gsube , Sigt , Sigc , Sigs
   COMMON /sdr2x5/ Ielid , Isilno , Smallv , Icssv , Ipinfl , Za , Zb , Imatid , A , I1 , I2 , Fj , Nsm , Fe , C1 , C2 , D1 , D2 ,  &
