...
!
   REAL Costh , Deps , Depss , Dum(297) , Dum1 , Dumcl(145) , Dummy(50) , Ecpt(32) , Ecptsa(100) , Elid , Eltemp , Eps0 , Eps1 ,    &
   ...
   INTEGER Idum2 , Idum3(3,3) , Inflag , Ipass , Ivec , Matid , Midgp , Necpt(32) , Necpts(32) , Nirof , Nogo , Npvt
