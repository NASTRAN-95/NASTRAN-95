...
!
   REAL angl , dict5 , dummy , et(9) , g(36) , gsube(9) , icosth , idetrm , isinth , it , itemp9(9) , jtemp9(9) , k1sum(9,16) ,     &
      & k5mod(9,5) , k5sum(9,5) , kij(1) , kmat(63) , kout(144) , ktemp9(9) , rmat(3,5) , tmat(36)
