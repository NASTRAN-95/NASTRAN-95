...
!
   REAL Absorp , Af , Avgtmp , Cpx , Csid(4,8) , D15(15) , Dmmm(2) , Ecpt(53) , Ecpt1 , Ecpt14 , Eltemp , Emiss , Hx , Pi , R1 ,    &
      & R2 , V(3)
...
!
   REAL a1(5) , a2(3) , a3(3) , a4(3) , c(16) , cc(4,4) , cp , dict5 , h , itemp , ke , mast(64) , master(8,8) , me
