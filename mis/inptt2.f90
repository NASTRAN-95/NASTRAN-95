...
!
   ...
   INTEGER Incr , Irow , Ksystm(65) , Line , Nb , Nlpp , Nout , Nrow , Nwds(4) , P1 , P2 , P3(2) , P4 , P5 , P6(2) , Prec(2) ,      &
         & Typin , Typout , X(1)
...
99012       FORMAT (20X,21HNAME OF DATA BLOCK = ,2A4)
      ...
      ENDDO
      IF ( P1/=mfiv .AND. P1/=msix ) GOTO 1400
      GOTO 2500
   ELSE
!     KEYX = 2
!     IF (KEY .NE. KEYX) GO TO 9918
