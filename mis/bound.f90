...
SUBROUTINE bound(Fbrec,Afe,Nafe,Kge,Nkge)
   ...
   CHARACTER*25 Uwm
   COMMON /blank / Nograv
   COMMON /flbptr/ Error , Icore , Lcore , Ibgpdt , Nbgpdt , Isil , Nsil , Igrav , Ngrav
   ...
   DOUBLE PRECISION a , aa , aa2 , aeps , aflel , aflstr , akj(3,4) , akjcon , astrel , astria , bb , c(4,7) , c1 , c2 , c3 , cc ,  &
                  ...
                  & ktwo(2,2) , leps , mag , nn , nn1 , nx , nz , p(2,7) , pt(3,4) , r12(3) , r13(3) , r14(3) , r24(3) , rhoxg ,    &
                  & s(48) , ss(9) , st(3,4) , t(3,3) , tfst(3,3) , tr(3,3) , tria , vtemp(3) , x1 , x2 , x3 , x4 , y(3) , y1 , y2 , &
                  & y3 , y4 , z1 , z2 , z3 , z4 , zz
   DOUBLE PRECISION dadotb , dapoly , dvmag
   INTEGER fedge(2,4) , fledge(2,4) , gf1 , gf2 , gf3 , gf4 , grid(3,4) , gs1 , gs2 , gs3 , gs4 , gsi , gsj , i , i1 , i2 , icol ,  &
         & iloc , irow , it , itria , j , jloc , k , k1loc , kk1 , kk2 , kloc , lgrav , loc , locfos(4) , locsof(4) , loctof(3) ,   &
         & m , n , ngridf , ngrids , npoly , nrow , stedge(2,3)
   REAL g
   LOGICAL grav
