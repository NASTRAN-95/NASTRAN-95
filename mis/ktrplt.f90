...
!
   DOUBLE PRECISION A(81) , Arr9(9) , Array9(9) , C1 , C2 , D1(3) , D2(3) , Determ , E(18) , Habc(18) , Hinv(36) , Hq(12) , Ivect(3)&
                  ...
                  & Y1 , Y2 , Ysubc
   REAL Alp12 , Alpha1 , Alpha2 , Consts(5) , Cosang , Costh , Degra , Dodet , Dum1(10) , Dum2(1) , Dum3(23) , Dumcl(7) , Dumtwo(2) &
      & , Ecpt(100) , Eltemp , G11 , G12 , G13 , G22 , G23 , G2x211 , G2x212 , G2x222 , G33 , Gsube , Rho , Sigcom , Sigshe ,       &
      & Sigten , Sinang , Sinth , Stress , Theta , Tsub0 , V1(3) , V2(3) , V3(3)
   INTEGER Idetck , If4gg , Ifkgg , Inflag , Iopt4 , Ising , K4ggsw , Km , Link(10) , Matid , Necpt(100) , Nogo , Npivot , Npoint , &
         & Npt1 , Npvt , Nsubc , Subsca , Subscb , Subscc
   ...
   COMMON /sma1dp/ A , S , T , Temp9 , Prod9 , Arr9 , Array9 , Hinv , Ksum , Xsubb , Xsubc , Ysubc , E , Temp , L1 , L2 , S1 , S2 , &
