...
!
   ...
   LOGICAL Heat
   INTEGER Idetck , If4gg , Ifkgg , Inflag , Iopt4 , K4ggsw , Link(10) , Matid , Mi , Mpoint , Necpt(8) , Ngrid(4) , Nogo , Npivot ,&
         & Npvt , Nsubsc
   DOUBLE PRECISION K3x3(27) , Kij(36) , Ksum(36) , Temp
   COMMON /condas/ Consts
   COMMON /matin / Matid , Inflag , Eltemp , Stress , Sinth , Costh
   COMMON /matout/ Dum99 , Gsube , Dum88
   COMMON /sma1cl/ Iopt4 , K4ggsw , Npvt , Dumcl , Link , Idetck , Dodet , Nogo
   COMMON /sma1dp/ Kij , Dum7 , Ksum , Temp , Cosang , Sinang , Vecl , Ivec , Jvec , Kvec , Pvec , Vsubk , V , Si , Npivot ,        &
