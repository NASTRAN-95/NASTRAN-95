...
!
   DOUBLE PRECISION a1sq , a2sq , a3sq , balotr(36) , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , cc(10) , cmt(1296) ,       &
                  ...
                  & rny1 , s11 , s13 , s22 , s23 , s33 , st , trand(9)
   REAL amass , area , blank , d11 , d12 , d13 , d22 , d23 , d33 , degra , f(14,14) , ivect(3) , jvect(3) , kvect(3) , nsm , rho ,  &
      & t1 , t2 , t3 , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 , tshr1 , tshr3 , tshr5 , vol , xc(6) , yc(6) , &
      & zc(6)
   INTEGER dict(11) , i , i1 , i1j1 , i2 , i3 , icode , ics(6) , idele , ii , ij , index(20,3) , ipass , iprec , ising , ism ,      &
         & ismall , j , j1 , j1i1 , ji , jj , k , k1 , l , l1 , m , matid1 , matid2 , mx , mx0 , mx01 , mx011 , mx0x , mx1 , mx1x , &
