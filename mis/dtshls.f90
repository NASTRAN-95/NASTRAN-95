...
!
   REAL a , a1 , a1sq , a2 , a2sq , a3 , a3sq , b , balotr(36) , blank , c , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 ,     &
      ...
      & es(6) , fl(3) , gl(3) , h4 , h5 , h6 , ivect(3) , j11 , j12 , j22 , jvect(3) , kshl(1024) , ksub(36) , ksubt(36) , kvect(3) &
      & , mshl(1024) , nsm , ph1out(250) , q(6,6) , qks(960) , qqq(20,20) , qqqinv(360) , rix , riy , rjx , rjy , rkx , rky , rlx , &
      & rly , rmnx , rmny
   INTEGER i , i1 , i2 , i3 , ics(6) , idele , ii , iirr , iirr1 , ij , ij1 , ijk , ik , ikrr , ikrr0 , ikrr1 , im , imrr1 ,        &
         & ind(6,3) , index(20,3) , ising , ix , iy , j , j1 , j2 , ji , jj , jjss , jjss0 , jl , jlss , jlss0 , jlss1 , jn , jnss ,&
         & jx , jy , k , k1 , k2 , ki , kirr , kirr0 , kirr1 , kk , kkrr , kkrr0 , km , kmrr , kx , ky , l , l1 , lj , ljss ,       &
         & ljss0 , ljss1 , ll , llss , llss1 , ln , lnss1 , lx , ly , m , matid1 , matid2 , matid3 , mi , mirr1 , mk , mkrr , mm ,  &
         & mmrr , mmrr0 , mmrr1 , mx , my , mz
   DOUBLE PRECISION ksubd(36)
   INTEGER name(2) , nj , njss , nl(6) , nlss1 , nn , nnss , nnss0 , nnss1 , npivot , npoint , npt1 , nsil(6) , nx , ny , rk(3) ,   &
         & rl(3) , rr , rr0 , rr1 , sil(6) , sil1 , sil2 , sk(3) , sl(3) , ss , ss0 , ss1 , xu(32) , xv(32) , xw(32) , yu(32) ,     &
         & yv(32) , yw(32)
   LOGICAL nogo , nots , uniben , unimem
   REAL rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny , rny1 , sb1 , sb10 , sb11 , sb12 , sb13 , sb14 , sb15 , sb16 , sb17 , sb18 ,    &
      & sb19 , sb2 , sb20 , sb21 , sb22 , sb23 , sb24 , sb25 , sb26 , sb27 , sb28 , sb29 , sb3 , sb30 , sb31 , sb32 , sb33 , sb34 , &
