...
SUBROUTINE tlqd4d
   IMPLICIT NONE
   DOUBLE PRECISION Anglei(4) , Degrad , Detj , Edgel(4) , Edgshr(3,4) , Hzta , Pi , Psitrn(9) , Raddeg , Twopi , Uev(3,4) ,        &
                  & Unv(3,4)
   LOGICAL Badjac , Bendng , Mbcoup , Membrn , Norpth , Shrflx
   REAL Bgpdt(4,4) , Buffer(100) , Eltemp , Elth , Est(45) , Gpth(4) , Matset , Rmtout(25) , Stemp(8) , Sysbuf , Z(20000) , Zoff ,  &
      & Zoff1
   INTEGER Comps , Flag , Inflag , Intz(1) , Iorder(4) , Iparam , Ipcmp , Ipcmp1 , Ipcmp2 , Matid , N1 , Nest(45) , Nnode , Nogo ,  &
         & Nout , Npcmp , Npcmp1 , Npcmp2 , Nrowsp , Rowflg , Sil(4)
   ...
   COMMON /sgtmpd/ Stemp
   COMMON /system/ Buffer
   COMMON /terms / Membrn , Bendng , Shrflx , Mbcoup , Norpth
   COMMON /trimex/ Est
   COMMON /zzzzzz/ Z
   DOUBLE PRECISION aa , abbd(6,6) , alfab(3) , alfam(3) , alpha(6) , alphad(6) , alphae(3) , alphal(3) , bb , bmatrx(144) , c ,    &
                  & c2 , cc , cent(3) , cente(3) , coeff , const , delta , deltat , determ , detg2 , detu , dgpth(4) , dshp(8) ,    &
                  & dshptp(8) , eps1 , epslnt(6) , epsubt(6) , eta , exi , exj , ftherm(6) , g(6,6) , g2(9) , g2i(9) , galpha(3) ,  &
                  & gbar(9) , gepsbt(6) , gge(9) , ggu(9) , gi(36) , glay(9) , glayt(9) , gprop(25) , gt(9) , gtemps(6) , jacob(9) ,&
                  & mintr , mominr , offset , phi(9) , pt(24) , ptg(24) , ptint(2) , reali , s , s2 , shp(4) , stiff(36) , talfab(3)&
                  & , talfam(3) , tbar , tbg(9) , tbm(9) , teb(9) , tem(9) , tempel , teu(9) , tgrad , theta , thetae , thetam ,    &
                  & thk , thrmom(3) , tlam , tmean , tmpshp(4) , trans(36) , transl(9) , tsubo
   REAL alpham(6) , bdum , bgpdm(3,4) , dum , ecpt(4) , egpdt(4,4) , epnorm(4,4) , gdum , gpnorm(4,4) , pa , tgrid(4,4) , ti ,      &
      & tmpthk(4) , tsub0 , zta
   LOGICAL compos , pcmp , pcmp1 , pcmp2 , tempp1 , tempp2
   INTEGER elid , i , i1 , ibot , iec , ieta , iflag , ig , ig1 , ig2 , ig4 , igpdt(4,4) , ii , ij , imat , imt , index(3,3) ,      &
         & indx(6,3) , ip , ipc11 , ipc21 , ipnt , ipoint , ipt , ir , isil , ising , isngg2 , isngu , itemp , itype , ix , ixsi ,  &
         & izta , j , jg , jg1 , jg2 , jg4 , jj , jpt1 , jpt2 , k , k1 , kcid(4) , kg , kk , kpt , kpt1 , ksil(4) , l , lamopt ,    &
         & lg , ll , lpc11 , lpcomp , lpoint , ltypfl , m , mcsid , mem , mid(4) , mm , morb , nam(2) , nd2 , nd3 , nd4 , nd5 ,     &
         & ndof , necpt(4) , nlay , nn , pcomp , pcomp1 , pcomp2 , pid , pidloc , sym , symmem
   DOUBLE PRECISION ttbar , tub(9) , tum(9) , u(9) , ugpdm(3,4) , v12(3) , v12dk , v41(3) , vd1(3) , vd2(3) , vis(3) , vjl , vjs(3) &
                  & , vkl , vkn(3) , vks(3) , vp12(3) , vp12l , x31 , x42 , xi , xm , xybmat(96) , y31 , y42 , ym , zk , zk1 ,      &
                  & zref , zsubi
!
