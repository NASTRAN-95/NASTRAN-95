...
!
   ...
   INTEGER Cls , Clsrew , Comps , Ept , Eptx , Icfiat , Inflag , Luset , Mach , Matid , Mpt , Mptx , Nogenl , Nogo , Nosimp ,       &
         & Nosup , Nout , Nsil , Pcomps , Rd , Rdrew , Sysbuf , Wrt , Wrtrew , Z(1)
...
!
   ...
   DOUBLE PRECISION c , c2 , c4 , const , determ , detrmn , dum(6) , dummy(3) , e(2) , ei(2) , epsi , ex , ey , fi(2) , fii(2) ,    &
                  & g(25) , g1(3,3) , g2(3,3) , g3(2,2) , g3bar(3,3) , g3br(9) , g3i(9) , g3invd(2,2) , g3iu(9) , g4(3,3) ,         &
                  & gbar(3,3) , gbr(9) , gd(9) , gd1(3,3) , gd2(3,3) , gd4(3,3) , gdbar(3,3) , gdbr(9) , gdt(9) , gt(9) ,           &
                  & gtrflx(2,2) , rho , ri(2) , s , s2 , s4 , stiff(6,6) , t(9) , theta , thetar , ti , tlam , trflx(2,2) , u(9) ,  &
                  & zbar(2) , zbarx , zbarxb , zbarxt , zbary , zbaryb , zbaryt , zg1 , zg2 , zg4 , zi , zk , zk1 , zref
   LOGICAL okuai
