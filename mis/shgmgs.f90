...
!
   INTEGER Elid
   REAL Gsube , Rho , Ts , Tsub0
   LOGICAL Noalfa
   REAL Alpha(6) , Egnor(4) , G(36) , Tem(9)
   INTEGER Mid(4)
!
! Local variable declarations
!
   REAL bdum , const , detu , dn12 , dn21 , gt(9) , nu21 , ps1 , ps2 , talpha(6) , tmtset , u(9)
...
!
         IF ( G(19)/=0.0 .OR. G(20)/=0.0 .OR. G(21)/=0.0 .OR. G(22)/=0.0 ) EXIT
         igobk = 1
         m = 2
         Mid(3) = 0
         Shrflx = .FALSE.
