...
!
   ...
   COMMON /sgtmpd/ Stemp
   COMMON /system/ Sysbuf , Nout , Nogo , Dum , Prec
...
!
   REAL aic(1) , alfab(3) , alfam(3) , alpha(6) , avgthk , bmatrx(162) , bterms(6) , cente(3) , detg2 , detjac , dgpth(6) , ecpt(4) &
      ...
      & shpt(3) , talfab(3) , talfam(3) , tbar , tbg(9) , teb(9) , tem(9) , teu(9) , tgrad , th , thetae , thetam , thrmom(3) ,     &
      & tmean , tmptrn(36) , trans(27) , ts , tsub0 , tub(9) , tum(9) , weight , wtstif
...
!
      CALL shgmgs(*300,elid,tem,mid,ts,noalfa,gi,rho,gsube,tsub0,egnor,alpha)
!
      DO ial = 1 , 3
         alfam(ial) = alpha(ial)
