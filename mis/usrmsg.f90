...
99045    FORMAT (A23,' 2041, A MATT1, MATT2, MATT3, OR MATS1 CARD REFER','ENCES TABLE NUMBER',I9,' WHICH IS NOT DEFINED ON',/5X,    &
...
99095    FORMAT (A27,' 2092, SDR2 FINDS A SYMMETRY SEQUENCE LENGTH =',I20,/5X,'AND AN INSUFFICIENT NUMBER OF VECTORS AVAILABLE=',   &
               & I21,' WHILE ATTEMPTING TO COMPUTE STRESSES AND FORCES.',/5X,'ALL FURTHER STRESS AND FORCE COMPUTATION TERMINATED.')
         GOTO 400
      ELSEIF ( l==93 ) THEN
...
99143 FORMAT (A29,' 2220, NO APPLICABLE ELEMENT OR SUBCASE DURING OUT','PUT SCAN',/5X,'EITHER NO VALUES OUTSIDE MAX-MIN RANGE ',    &
