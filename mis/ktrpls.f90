...
!
   ...
   INTEGER Elid , Eltype , Estid , Flags(3) , Icore , Iest(42) , Ioutpt , Jcore , Ksystm(65) , Ldict , Matflg , Matid , Ncore ,     &
         & Nlocs , Nok , Nom , Precis
   CHARACTER*23 Ufm
   COMMON /blank / Nok , Nom
   COMMON /emgdic/ Eltype , Ldict , Nlocs , Elid , Estid
   COMMON /emgest/ Est
   COMMON /emgprm/ Icore , Jcore , Ncore , Dum , Flags , Precis
...
!
   REAL a1sq , a2sq , a3sq , amass , area , balotr(36) , blank , c1 , c10 , c2 , c3 , c4 , c5 , c6 , c7 , c8 , c9 , cc(10) ,        &
      ...
      & qqq(20,20) , qqqinv(360) , rho , rmnx , rmny , rmx , rmx1 , rmy , rmy1 , rnx , rnx1 , rny , rny1 , s11 , s13 , s22 , s23 ,  &
      & s33 , st , t1 , t2 , t3 , theta1 , thetam , thk1 , thk2 , thk3 , tmem1 , tmem3 , tmem5 , trand(9) , tshr1 , tshr3 , tshr5 , &
      & vol , xc(6)
   INTEGER dict(11) , i , i1 , i1j1 , i2 , i3 , icode , ics(6) , idele , ii , ij , index(20,3) , ipass , iprec , ising , ism ,      &
         & ismall , j , j1 , j11 , j12 , j1i1 , j22 , ji , jj , k , k1 , l , l1 , m , matid1 , matid2 , mx , mx0 , mx01 , mx011 ,   &
         & mx0x , mx1 , mx1x , mx2 , mx2x , mx3 , mx3x , my , my1 , my1x , name(2) , ndof , nl(6) , nx , nx0 , nx01 , nx011 , nx0y ,&
         & nx1 , nx1y , nx2 , nx2y , nx3 , nx3y , ny , ny1 , ny1y , save(6) , sil1 , sil2 , small(6) , xpower(20) , xthk(10) ,      &
         & ypower(20) , ythk(10)
