...
SUBROUTINE ktrbsc(Iopt)
   ...
   DOUBLE PRECISION A(225) , Area , D(9) , Determ , E(18) , G(9) , G2x2(4) , J2x2(4) , Prod9(9) , Px2 , Pxy2 , Py2 , S(18) , Temp , &
                  ...
                  & Ybar3 , Ycsq , Ysubc
   REAL Alp12 , Alpha1 , Alpha2 , Angle , Consts(5) , Costh , Degra , Dodet , Dum1(10) , Dum2(1) , Dum3(23) , Dumb(76) , Dumcl(7) , &
      & Dumdum(4) , Dummy(30) , Dummy1 , Dummy2 , Dummy3 , Ecpt(25) , Eltemp , Eye , Fmu , G11 , G12 , G13 , G22 , G23 , G2x211 ,   &
      & G2x212 , G2x222 , G33 , Gsube , Rho , Sigcom , Sigshe , Sigten , Sinth , Stress , T2 , Theta , Tsub0 , X1 , X2 , X3 , Y1 ,  &
      & Y2 , Y3 , Z1 , Z11 , Z2 , Z22 , Z3
   INTEGER Idetck , If4gg , Ifkgg , Inflag , Iopt4 , Ising , K4ggsw , Link(10) , Matid , Matid1 , Matid2 , Nbegin , Necpt(1) ,      &
         & Ngrid(3) , Nogo , Npivot , Npvt , Nsized , Nsubc , Subsca , Subscb
   ...
   COMMON /sma1dp/ A , Prod9 , Temp9 , Xsubb , Xsubc , Ysubc , E , Temp , Xbar , Area , Xcsq , Ybar2 , Ycsq , Ybar , Xbsq , Px2 ,   &
